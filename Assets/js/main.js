$(document).ready(() => {
	...
	const addUpdateInfo = (date, patchVersion, patchLink) => {
		$("#inner_update").prepend(
			`<p>Последнее обновление: ${date} | Патч: ${patchVersion}</p>`
		);
		$("#patch_info").prepend(
	...
	addUpdateInfo(
		"17.12.2024",
		"7.15",
		"https://eu.finalfantasyxiv.com/lodestone/topics/detail/78bd87d42626b597d2a3a5d7075b56c2604cd14b"
	);
