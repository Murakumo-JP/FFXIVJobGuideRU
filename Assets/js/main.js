...
$(document).ready(() => {
	...
	fetch(`${JSON_URLS.UPDATES}?v=${Date.now()}`)
		...
		.then((data) => {
			...
			$("#patch_info").prepend(
				`Все описания основаны на характеристиках умений и бонусах, актуальных для 100 уровня.<br/>
                 Подробную информацию об изменениях в активных умениях и пассивных навыках можно найти 
