(() =>{
   let db = {
      ...
      "PVE Skill 04": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 110 по всем окружающим противникам.<br/>Дополнительный эффект: повышает уровень угрозы',
      },
      // PVE Skill 05
      "PVE Skill 05": {
         "name": 'Defiance',
      ...
      "PVE Skill 08": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 220.<br/>Комбо умение: Maim<br/>Сила в комбо: 500<br/>Комбо бонус эффекта: восстанавливает HP персонажа<br/>Сила лечения: 250<br/>Комбо бонус: восполняет ресурс шкалы Beast Gauge на 20',
      },
      // PVE Skill 09
      "PVE Skill 09": {
      ...
      "PVE Skill 15": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 220.<br/>Комбо умение: Maim<br/>Сила в комбо: 500<br/>Комбо бонус: накладывает эффект Surging Tempest, увеличивающий наносимый урон на 10%<br/>Продолжительность: 30 сек.<br/>Увеличивает продолжительность эффекта Surging Tempest на 30 сек., вплоть до 60 секунд.<br/>Комбо бонус: восполняет ресурс шкалы Beast Gauge на 10',
      },
      // PVE Skill 16
      "PVE Skill 16": {
         "name": 'Infuriate',
      ...
      "PVE Skill 22": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 420.<br/>Имеет общее время восстановления с умением Orogeny.',
      },
      // PVE Skill 23
      "PVE Skill 23": {
         "name": 'Shake It Off',
      ...
      "Trait 17": {
         ...
         "job_icon": 'WAR',
         "level": '94',
         "content": "Увеличивает силу атаки умениям Heavy Swing до 2240, Maim до 190, Storm's Path до 220, Storm's Eye до 220, Fell Cleave до 580 и Upheaval до 420.",
      },
      // Trait 18 NEW
      "Trait 18": {
      ...
      "PVP Skill 02": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 6,000.<br/>Комбо умение: Heavy Swing<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 03
      "PVP Skill 03": {
         "name": "Storm's Path",
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 7,000.<br/>Комбо умение: Maim<br/>Дополнительный эффект: поглощает 100% нанесенного урона в виде HP<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Primal Rend',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон в прыжке по цели и всем противникам поблизости с силой атаки 8,000.<br/>Сила атаки Inner Release: 12,000<br/>Дополнительный эффект: оглушение (stun)<br/>Продолжительность: 2 сек.<br/>Дополнительный эффект: накладывает эффект Primal Ruination Ready<br/>Продолжительность: 15 сек.<br/>Невозможно использовать, если персонаж находится под эффектами ограничивающими перемещение.<br/>Этот боевой навык не имеет общего время восстановления с другими умениями.<br/><br/>※Умение меняется на Primal Ruination после использования.',
      },
      // PVP Skill 05
      "PVP Skill 05": {
         "name": 'Onslaught',
      ...
      "PVP Skill 06": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 1,000 всем окружающим противникам.<br/>Сила атаки увеличивается до 10,000, когда значение HP близко к максимальному.<br/>Расходует 10% текущего HP при использовании.<br/>Дополнительный эффект: снижает наносимый целью урон на 10%<br/>Продолжительность: 10 сек.',
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'Blota',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Мгновенно притягивает цель к персонажу.<br/>Дополнительный эффект: тяжесть (heavy) +75%<br/>Продолжительность: 3 сек.<br/>Дополнительный эффект: накладывает эффект Inner Chaos Ready<br/>Продолжительность: 15 сек.<br/><br/>※Умение меняется на Inner Chaos при использовании.',
      },
      // PVP Skill 08
      "PVP Skill 08": {
         "name": 'Bloodwhetting',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Накладывает эффекты Bloodwhetting и Stem the Tide.<br/>Эффект Bloodwhetting: восстанавливает HP в размере 100% от наносимого урона<br/>Продолжительность: 10 сек.<br/>Эффект Stem the Tide: создает вокруг себя барьер, поглощающий урон, в размере 20% от максимального HP персонажа<br/>Продолжительность: 10 сек.<br/>Дополнительный эффект: накладывает Chaotic Cyclone Ready<br/>Продолжительность: 15 сек.<br/><br/>※Умение меняется на Chaotic Cyclone при использовании.',
      },
      // PVP Skill 09
      "PVP Skill 09": {
         "name": 'Fell Cleave',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 10,000.<br/>Может быть использовано только под действием эффекта Inner Release.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 10
      "PVP Skill 10": {
         "name": 'Primal Ruination',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 10,000 по цели и всем окружающим противникам.<br/>Сила атаки Inner Release: 14,000<br/>Может быть использовано только под действием эффекта Primal Ruination Ready.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 11
      "PVP Skill 11": {
         "name": 'Inner Chaos',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 12,000 по всем окружающим противникам.<br/>Сила атаки Inner Release: 16,000<br/>Может быть использовано только под действием эффекта Inner Chaos Ready.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 12
      "PVP Skill 12": {
         "name": 'Chaotic Cyclone',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 8,000 по всем окружающим противникам.<br/>Сила атаки Inner Release: 12,000<br/>Может быть использовано только под действием эффекта Chaotic Cyclone Ready.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 13
      "PVP Skill 13": {
         "name": 'Primal Wrath',
         ...
         "radius_img": 'R2',
         "radius": '10y',
         "content": 'Удар, наносящий урон с силой атаки 6,000 по всем окружающим противникам.<br/>Дополнительный эффект: связывание (bind)<br/>Продолжительность: 3 сек.<br/>Может быть использовано только под действием эффекта Wrathful.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill LB
      "PVP Skill LB": {
         "name": 'Primal Scream',
