(() =>{
   let db = {
      ...
      "PVP Skill 05": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Рывок к цели, наносящий урон с силой атаки 400.<br/>Сила атаки увеличивается до 4,000, когда значение HP близко к максимальному.<br/>Расходует 10% текущего HP при использовании.<br/>Дополнительный эффект: увеличивает урон получаемый целью на 10%<br/>Продолжительность: 10 сек.<br/>Невозможно использовать, если персонаж находится под эффектами ограничивающими перемещение.',
      },
      // PVP Skill 06
      "PVP Skill 06": {
         "name": 'Orogeny',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 800 всем окружающим противникам.<br/>Сила атаки увеличивается до 8,000, когда значение HP близко к максимальному.<br/>Расходует 20% текущего HP при использовании.<br/>Дополнительный эффект: снижает наносимый целью урон на 10%<br/>Продолжительность: 10 сек.',
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'Blota',
