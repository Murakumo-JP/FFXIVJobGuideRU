(() =>{
   let db = {
      ...
      "PVP Skill 05": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Окутывает цель медленно горящим огнем. На время действия эффекта умение меняется на Detonator.<br/>Наносит урон цели и всем противникам в радиусе 5 ялмов по истечении времени или при использовании Detonator.<br/>Продолжительность: 8 сек.<br/>Сила атаки увеличивается на 3,000 за каждое атакующее умение персонажа, которое он совершаете до окончания действия эффекта.<br/>Если персонаж нанесет 5 атакующих умения по цели, то медленно горящая цель немедленно взорвется.',
      },
      // PVP Skill 06
      "PVP Skill 06": {
