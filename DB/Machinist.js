(() =>{
   let db = {
      ...
      "PVE Skill 06": {
         ...
         "radius_img": 'R4',
         "radius": '12y',
         "content": 'Удар, наносящий урон с силой атаки 110 по всем противникам в конусе перед персонажем.<br/>Дополнительный эффект: восполняет Heat Gauge на 5',
      },
      // PVE Skill 07
      "PVE Skill 07": {
         "name": 'Clean Shot',
      ...
      "PVE Skill 15": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон по всем ближайшим противникам с силой атаки 130 для первого и на 40% меньше для всех остальных.<br/>Максимум зарядов: 3',
      },
      // PVE Skill 16
      "PVE Skill 16": {
         "name": 'Auto Crossbow',
      ...
      "PVE Skill 18": {
         ...
         "radius_img": 'R1',
         "radius": '30y',
         "content": 'Снижает урон получаемый персонажем и сопартийцами на 15%.<br/>Продолжительность: 15 сек.<br/>Эффект не суммируется с умением Troubadour барда или Shield Samba дансера.',
      },
      // PVE Skill 19
      "PVE Skill 19": {
         "name": 'Drill',
      ...
      "PVE Skill 22": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 160.<br/>Комбо умение: Heated Slug Shot<br/>Сила в комбо: 420<br/>Комбо бонус: восполняет Heat Gauge на 5<br/>Комбо бонус: восполняет Battery Gauge на 10',
      },
      // PVE Skill 23
      "PVE Skill 23": {
      ...
      "PVE Skill 25": {
         ...
         "radius_img": 'R4',
         "radius": '12y',
         "content": 'Наносит периодический урон по всем противникам в конусе перед персонажем.<br/>Сила атаки: 100<br/>Продолжительность: 10 сек.<br/>Умение прервется при использовании умений или перемещении персонажа (включая разворот в другие стороны).<br/>Прерывает авто атаки при использовании умения.<br/>Запускает время восстановления боевых навыков после использования. Не может использоваться во время восстановления боевых навыков.',
      },
      // PVE Skill 26
      "PVE Skill 26": {
         "name": 'Bioblaster',
      ...
      "PVE Skill 33": {
         ...
         "radius_img": 'R4',
         "radius": '12y',
         "content": 'Удар, наносящий урон с силой атаки 130 по всем противникам в конусе перед персонажем.<br/>Дополнительный эффект: восполняет Heat Gauge на 10',
      },
      // PVE Skill 34
      "PVE Skill 34": {
      ...
      "PVE Skill 36": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон по цели и по всем окружающим противникам с силой атаки 170 для первого противника и на 40% меньше для всех остальных.<br/>Максимум зарядов: 3',
      },
      // PVE Skill 37 NEW
      "PVE Skill 37": {
         "name": 'Checkmate',
      ...
      "PVE Skill 39": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон по цели и по всем окружающим противникам с силой атаки 900 для первого противника и на 40% меньше для всех остальных.<br/>Наносимый урон увеличивается под действием эффектов, повышающего вероятность критического (critical) и прямого (direct) урона.<br/>Можно использовать только под действием эффекта Full Metal Machinist.',
      },
      // Trait 01
      "Trait 01": {
      ...
      "Trait 18": {
         ...
         "job_icon": 'MCH',
         "level": '94',
         "content": 'Увеличивает силу атаки Auto Crossbow до 160, Heated Split Shot до 220, Heated Slug Shot до 140, Heated Clean Shot до 160 и Blazing Shot до 240.',
      },
      // Trait 19 NEW
      "Trait 19": {
      ...
      "PVP Skill 01": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Дальний удар, наносящий урон с силой атаки 6,000.<br/>ПДополнительный эффект: накладывает стак Heat, вплоть до 4<br/>ППродолжительность: 15 сек.<br/>ППри максимальном количестве стаков накладывает Overheated и увеличивает скорость передвижения на 25%.<br/>ППродолжительность: 5 сек.<br/>ПДля используется требуется время применения. Однако во время применения можно перемещаться.<br/>П<br/>П※Умение меняется на Blazing Shot под действием эффекта Overheated.',
      },
      // PVP Skill 02
      "PVP Skill 02": {
         "name": 'Scattergun',
         ...
         "radius_img": 'R4',
         "radius": '12y',
         "content": 'Удар, наносящий урон с силой атаки 6,000 по всем противникам в конусе перед персонажем.<br/>Наносит двойной удар, если поражает только одну цель.<br/>Дополнительный эффект: отбрасывает цель на 10 ялмов назад<br/>Этот боевой навык не имеет общего времени восстановления с другими умениями. ',
      },
      // PVP Skill 03
      "PVP Skill 03": {
         "name": 'Drill',
      ...
      "PVP Skill 04": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 10,000 по цели и ближайшим противникам.<br/>Наносит двойной удар, но при втором ударе сила атаки уменьшается вдвое.<br/>Дополнительный эффект: накладывает эффект Overheated<br/>Продолжительность: 5 сек.<br/>Эффект Overheated: увеличивает скорость передвижения на 25%<br/>Увеличивает длительность перегрева на 5 сек, до максимума 10 сек.<br/>Этот боевой навык не имеет общего времени восстановления с другими умениями.<br/><br/>※Blast Charge меняется на Blazing Shot под действием эффекта Overheated.',
      },
      // PVP Skill 05
      "PVP Skill 05": {
         "name": 'Wildfire',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Окутывает цель медленно горящим огнем. На время действия эффекта умение меняется на Detonator.<br/>Наносит урон цели и всем противникам в радиусе 5 ялмов по истечении времени или при использовании Detonator.<br/>Продолжительность: 8 сек.<br/>Сила атаки увеличивается на 4,000 за каждое атакующее умение персонажа, которое он совершаете до окончания действия эффекта.<br/>Если персонаж нанесет 4 атакующих умения по цели, то медленно горящая цель немедленно взорвется.',
      },
      // PVP Skill 06
      "PVP Skill 06": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Развертывает боевую турель, которая будет наносить авто атаки по противникам с силой атаки 6,000.<br/>Продолжительность: 10 сек.<br/>Дополнительный эффект: создает барьер, поглощающий урон, равный силе лечения 6,000<br/>Продолжительность: 7 сек.',
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'Analysis',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Накладывает эффект, дающий дополнительные эффекты умениям Drill, Bioblaster, Air Anchor и Chain Saw при выполнении этих боевых навыков.<br/>Продолжительность: 10 сек.<br/>Дополнительный эффект Drill: сила атаки увеличена до 200%<br/>Дополнительный эффект Bioblaster: сила атаки и периодический урон увеличены на 50%<br/>Дополнительный эффект Air Anchor: сила атаки увеличена на 50%, а эффект связывания (bind) становится оглушением (stun)<br/>Дополнительный эффект Chain Saw: увеличивает получаемый целью урон<br/>Максимум зарядов: 2',
      },
      // PVP Skill 08
      "PVP Skill 08": {
         "name": 'Blazing Shot',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Дальний удар, наносящий урон с силой атаки 8,000.<br/>Может быть выполнено только под действием Overheated.<br/>Этот боевой навык не имеет общего времени восстановления с другими умениями.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 09
      "PVP Skill 09": {
         "name": 'Bioblaster',
         ...
         "radius_img": 'R4',
         "radius": '12y',
         "content": 'Удар, наносящий урон с силой атаки 4,000 по всем противникам в конусе перед персонажем.<br/>Дополнительный эффект: периодический урон<br/>Сила атаки: 4,000<br/>Продолжительность: 9 сек.<br/>Дополнительный эффект: увеличивает силу атаки и периодический урон на 50%, пока персонаж находится под эффектом Analysis<br/>Дополнительный эффект: накладывает эффект Air Anchor Primed<br/>Максимум зарядов: 2<br/>Может быть выполнено только под действием эффекта Bioblaster Primed.<br/>Этот боевой навык не имеет общего времени восстановления с другими умениями.<br/><br/>※Умение меняется на Air Anchor под действием эффекта Air Anchor Primed.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 10
      "PVP Skill 10": {
         "name": 'Air Anchor',
      ...
      "PVP Skill 11": {
         ...
         "radius_img": 'R6',
         "radius": '25y',
         "content": 'Удар, наносящий урон по всем противникам по прямой линии перед персонажем с силой атаки 12,000.<br/>Дополнительный эффект: сила атаки увеличивается на 20% при наличии эффекта Analysis<br/>Продолжительность: 6 сек.<br/>Дополнительный эффект: накладывает эффект Drill Primed<br/>Максимум зарядов: 2<br/>Может быть выполнено только под действием эффекта Chain Saw Primed.<br/>Этот боевой навык не имеет общего времени восстановления с другими умениями.<br/><br/>※Умение меняется на Drill под действием эффекта Drill Primed.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 12
      "PVP Skill 12": {
         "name": 'Detonator',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Завершает действие эффекта Wildfire, нанося урон цели.<br/>Может быть использовано только под действием эффекта Wildfire.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 13
      "PVP Skill 13": {
         "name": 'Aether Mortar',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 6000 по всем ближайшим противникам.<br/>Дополнительный эффект: создает барьер, поглощающий урон, равный силе лечения 6,000<br/>Продолжительность: 6 сек.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill LB
      "PVP Skill LB": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Дальний удар, наносящий урон с силой атаки 40,000.<br/>Может быть использовано только тогда, когда шкала лимит брейка (limit gauge) заполнена.<br/>Время зарядки шкалы: 90 сек.',
      },
   };
   FILL_DB_VALUES(db);
   FILL_DB_SKILLS(db);
