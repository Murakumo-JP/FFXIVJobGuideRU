(() =>{
   let db = {
      ...
      "PVE Skill 35": {
         ...
         "radius_img": 'R6',
         "radius": '10y',
         "content": 'Удар, наносящий физический урон по прямой линиии по всем противникам перед персонажем с силой атаки 1,000 для первого и на 50% меньше для остальных.<br/>Можно использовать только при активном эффекте Scorn.',
      },
      // Trait 01
      "Trait 01": {
         "name": 'Tank Mastery',
