(() =>{
   let db = {
      ...
      "Trait 12": {
         ...
         "job_icon": 'RPR',
         "level": '94',
         "content": "Увеличивает силу атаки Slice до 420, Waxing Slice до 260, Infernal Slice до 280, Soul Slice до 520, Gibbet до 500, Gallows до 500, Unveiled Gibbet до 440, Unveiled Gallows до 440, Void Reaping до 540, Cross Reaping до 540, Harvest Moon до 800 и Lemure's Slice до 280.",
      },
      // Trait 13 NEW
      "Trait 13": {
      ...
      "PVP Skill 02": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 6,000.<br/>Комбо умение: Slice<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 03
      "PVP Skill 03": {
         "name": 'Infernal Slice',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 7,000.<br/>Комбо умение: Waxing Slice<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Harvest Moon',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 8,000 по цели и всем ближайшим противникам.<br/>Сила атаки увеличивается до 12,000 по мере уменьшения HP цели и достигает максимального значения, когда у цели остается 50% HP или меньше.<br/>Дополнительный эффект: поглощает 50% нанесенного урона в виде HP<br/>Максимум зарядов: 2<br/>Этот боевой навык не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 05
      "PVP Skill 05": {
         "name": 'Plentiful Harvest',
         ...
         "radius_img": 'R6',
         "radius": '15y',
         "content": "Удар, наносящий урон по всем противникам по прямой линии с силой атаки 8,000.<br/>Сила атаки увеличивается до 24,000 в зависимости от накопленных стаков Immortal Sacrifice, полученных за выполнение Executioner's Guillotine, убийства противников или получение ассистов.<br/>Дополнительный эффект: постепенно заполняет шкалу лимит брейка<br/>При использовании расходует все стаки Immortal Sacrifice.<br/>Может быть использовано только в то время, когда на персонажа не наложен эффект Enshrouded.<br/>Этот боевой навык не имеет общего времени восстановления с другими умениями.",
      },
      // PVP Skill 06
      "PVP Skill 06": {
         "name": 'Grim Swathe',
         ...
         "radius_img": 'R4',
         "radius": '8y',
         "content": "Призывает аватар, наносящего удар с силой атаки 4,000 по всем противникам в конусе перед персонажем.<br/>Дополнительный эффект: накладывает эффект Executioner's Guillotine Ready<br/>Продолжительность: 10 сек.<br/>Дополнительный эффект: тяжесть (heavy) +75%<br/>Продолжительность: 3 сек.<br/><br/>※Infernal Slice Combo меняется на Executioner's Guillotine при использовании.",
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'Death Warrant',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Накладывает на цель эффект Death Warrant, накапливающий урон, который персонаж наносит цели. На время действия эффекта умение меняется на Fate Sealed.<br/>Наносит урон по истечении времени или при использовании Fate Sealed.<br/>Продолжительность: 8 сек.<br/>Сила атаки: 2,000 плюс 50% от накопленного урона',
      },
      // PVP Skill 08
      "PVP Skill 08": {
         "name": "Hell's Ingress",
      ...
      "PVP Skill 10": {
         ...
         "radius_img": 'R4',
         "radius": '8y',
         "content": "Удар, наносящий урон с силой атаки 8,000 по всем противникам в конусе перед персонажем.<br/>Дополнительный эффект: накладывает стак Immortal Sacrifice, вплоть до 8<br/>Можно использовать только под действием эффекта Executioner's Guillotine.<br/><br/>※Это умение нельзя поместить на хотбар.",
      },
      // PVP Skill 11
      "PVP Skill 11": {
         "name": 'Void Reaping',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 10,000.<br/>Может быть использовано только под действием эффекта Enshrouded.<br/>Этот боевой навык не имеет общего времени восстановления с другими умениями.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 12
      "PVP Skill 12": {
         "name": 'Cross Reaping',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 10,000.<br/>Комбо умение: Void Reaping<br/>Может быть использовано только под действием эффектов Enshrouded.<br/>Этот боевой навык не имеет общего времени восстановления с другими умениями.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 13
      "PVP Skill 13": {
         "name": "Lemure's Slice",
         ...
         "radius_img": 'R4',
         "radius": '8y',
         "content": 'Удар, наносящий урон с силой атаки 6,000 по всем противникам в конусе перед персонажем.<br/>Дополнительный эффект: связывание (bind)<br/>Продолжительность: 3 сек.<br/>Можно использовать только под действием эффекта Enshrouded.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 14
      "PVP Skill 14": {
         "name": 'Fate Sealed',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Завершает действие эффекта Death Warrant, нанося урон цели.<br/>Сила атаки: 2,000 плюс 50% от накопленного урона<br/>Может быть использовано только под действием эффекта Death Warrant.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 15
      "PVP Skill 15": {
         "name": 'Regress',
      ...
      "PVP Skill 16": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 15,000 по цели и всем ближайшим противникам.<br/>Дополнительный эффект: накладывает эффект Perfectio Parata<br/>Требуется как минимум один стак эффекта Enshrouded.<br/>При использовании расходует все стаки эффекта Enshrouded.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Умение меняется на Perfectio после использования.',
      },
      // PVP Skill 17
      "PVP Skill 17": {
         "name": 'Perfectio',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 10,000 по цели и всем ближайшим противникам, чье HP ниже 25%.<br/>Не действует на неигровых персонажей и игроков, находящихся в роботах.<br/>Может быть использовано только под действием эффекта Perfectio Parata.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill LB
      "PVP Skill LB": {
