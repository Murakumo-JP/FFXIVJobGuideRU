(() =>{
   let db = {
      ...
      "PVP Skill 11": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 10,000 по цели и всем ближайшим противникам.<br/>Может быть выполнено только под эффектом Starcross Ready.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 12
      "PVP Skill 12": {
         "name": 'Nastrond',
