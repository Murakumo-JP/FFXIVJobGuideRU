(() =>{
   let db = {
      ...
      "PVP Role Action 01": {
         ...
         "radius_img": 'R2',
         "radius": '10y',
         "content": "Удар, наносящий урон с силой атаки 8,000 по всем блажиайшим противникам.<br/>Дополнительный эффект: увеличивает получаемый целью урон на 25%<br/>Продолжительность: 10 сек.",
      },
      // PVP Role Action 02
      "PVP Role Action 02": {
         "name": 'Rampart',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": " Уменьшает наносимый урон на 50%, одновременно увеличивая HP, восстанавливаемое лечебными умениями на 25%.<br/>Продолжительность: 15 сек.",
      },
      // PVP Role Action 03
      "PVP Role Action 03": {
         "name": 'Full Swing',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": "Удар, наносящий урон с силой атаки 8,000.<br/>Дополнительный эффект: отталкивание на 30 ялмов<br/>Снимает Guard с противников, находящихся под его эффектом.",
      },
      // PVP Role Action 04
      "PVP Role Action 04": {
         "name": 'Haelan',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": "Восстанавливает HP цели.<br/>Сила лечения: 12,000",
      },
      // PVP Role Action 05
      "PVP Role Action 05": {
         "name": 'Stoneskin II',
         ...
         "radius_img": 'R2',
         "radius": '15y',
         "content": "Создает барьер вокруг персонажа или сопартийца, поглощающий урон, равный лечению с силой 10,000.<br/>Продолжительность: 10 сек.",
      },
      // PVP Role Action 06
      "PVP Role Action 06": {
         "name": 'Diabrosis',
         ...
         "radius_img": 'R2',
         "radius": '10y',
         "content": "Удар, наносящий нестихийный урон с силой атаки 8,000 по цели и всем ближайшим противникам.<br/>Дополнительный эффект: уменьшает HP цели, восстанавливаемое лечебными умениями на 25%<br/>Продолжительность: 10 сек.",
      },
      // PVP Role Action 07
      "PVP Role Action 07": {
         "name": 'Bloodbath',
         "skill_icon": 'https://lds-img.finalfantasyxiv.com/d/3f4e049b56fe58f93ddf61cec1e4157675ad7f02.png',
         "classification": 'Способность',
         "cast": 'Мгновенная',
         "recast": '45 сек.',
         "range": '0y',
         "radius_img": 'R1',
         "radius": '0y',
         "content": "Преобразует 100% наносимого физического урона в HP.<br/>Продолжительность: 10 сек.",
      },
      // PVP Role Action 08
      "PVP Role Action 08": {
         "name": 'Swift',
         "skill_icon": 'https://lds-img.finalfantasyxiv.com/d/4c0e196518ec2d5f7f584cc2c9824930f303a531.png',
         "classification": 'Способность',
         "cast": 'Мгновенная',
         "recast": '30 сек.',
         "range": '0y',
         "radius_img": 'R1',
         "radius": '0y',
         "content": "Увеличивает скорость передвижения на 100% и дает иммунитет к эффектам оглушения (stun), тяжести (heavy), связывания (bind), безмолвия (silence), полу сна (half-asleep), сна (sleep), глубокой заморозки (deep freeze), а также к отбрасывающим и притягивающим эффектам.<br/>Продолжительность: 4 сек.<br/>Эффект прекращается при езде на маунте.",
      },
      // PVP Role Action 09
      "PVP Role Action 09": {
         "name": 'Smite',
         "skill_icon": 'https://lds-img.finalfantasyxiv.com/d/83978e6c6cfafeb1e30bf085e884b9c2030435db.png',
         "classification": 'Способность',
         "cast": 'Мгновенная',
         "recast": '15 сек.',
         "range": '10y',
         "radius_img": 'R1',
         "radius": '0y',
         "content": "Удар, наносящий урон с силой атаки 6,000.<br/>Сила атаки увеличивается до 18, 000 по мере уменьшения HP цели, достигая максимального значения, когда у цели остается 25% здоровья или меньше.<br/>Время восстановления сбрасывается при получении убийства или ассиста.",
      },
      // PVP Role Action 10
      "PVP Role Action 10": {
         "name": 'Dervish',
         "skill_icon": 'https://lds-img.finalfantasyxiv.com/d/7d8fbe1550c91afbd4d4349a0aab9dab9a1e04ab.png',
         "classification": 'Способность',
         "cast": 'Мгновенная',
         "recast": '45 сек.',
         "range": '0y',
         "radius_img": 'R2',
         "radius": '15y',
         "content": "Сокращает время применения и восстановления боевых навыков, заклинаний и авто атак на 10%, а также увеличивает скорость передвижения на 25% персонажа и ближайших сопартийцев.<br/>Продолжительность: 12 сек.",
      },
      // PVP Role Action 11
      "PVP Role Action 11": {
         "name": 'Bravery',
         "skill_icon": 'https://lds-img.finalfantasyxiv.com/d/5224aafe6eaf21b1b9a559865b37b023524ae0c7.png',
         "classification": 'Способность',
         "cast": 'Мгновенная',
         "recast": '30 сек.',
         "range": '30y',
         "radius_img": 'R1',
         "radius": '0y',
         "content": "Увеличивает наносимый урон на 25% и уменьшает получаемый урон на 25%.<br/>Продолжительность: 10 сек.",
      },
      // PVP Role Action 12
      "PVP Role Action 12": {
         "name": 'Eagle Eye Shot',
         "skill_icon": 'https://lds-img.finalfantasyxiv.com/d/67522181f502fda37e11dd98b9bf8e8f337f36fa.png',
         "classification": 'Способность',
         "cast": 'Мгновенная',
         "recast": '15 сек.',
         "range": '40y',
         "radius_img": 'R1',
         "radius": '0y',
         "content": "Удар, наносящий урон с силой атаки 12,000.<br/>Игнорирует эффект Guard при нанесении урона.",
      },
      // PVP Role Action 13
      "PVP Role Action 13": {
         "name": 'Comet',
         "skill_icon": 'https://lds-img.finalfantasyxiv.com/d/e4fc5a2a1a14cc8831e9b5d0cf2e3188af51e3c0.png',
         "classification": 'Заклинание',
         "cast": '2.4 сек.',
         "recast": '45 сек.',
         "range": '30y',
         "radius_img": 'R2',
         "radius": '10y',
         "content": "Удар, наносящий нестихийный урон противникам с силой атаки 20,000 в указанной области. Персонаж не можете двигаться во время произнесения заклинания и не можете отменить его после произнесения.",
      },
      // PVP Role Action 14
      "PVP Role Action 14": {
         "name": 'Phantom Dart',
         "skill_icon": 'https://lds-img.finalfantasyxiv.com/d/73d32dda03743186181568f145a260d41487e51c.png',
         "classification": 'Способность',
         "cast": 'Мгновенная',
         "recast": '15 сек.',
         "range": '25y',
         "radius_img": 'R1',
         "radius": '0y',
         "content": "Удар, наносящий нестихийный урон с силой атаки 4,000.<br/>Дополнительный эффект: увеличивает получаемый целью урон на 25%<br/>Продолжительность: 5 сек.",
      },
      // PVP Role Action 15
      "PVP Role Action 15": {
         "name": 'Rust',
         "skill_icon": 'https://lds-img.finalfantasyxiv.com/d/9c24680d2c87ff15f7815d8b2dfba4c17e2ccf20.png',
         "classification": 'Способность',
         "cast": 'Мгновенная',
         "recast": '30 сек.',
         "range": '25y',
