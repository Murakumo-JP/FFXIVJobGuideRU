(() =>{
   let db = {
      ...
      "PVE Skill 34": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по всем ближайшим противникам с силой атаки 800 для первого и на 60% меньше для всех остальных.<br/>Может быть использовано только под действием эффекта Thorned Flourish.',
      },
      // PVE Skill 35 NEW
      "PVE Skill 35": {
         "name": 'Grand Impact',
      ...
      "Trait 15": {
         ...
         "job_icon": 'RDM',
         "level": '94',
         "content": 'Увеличивает силу атаки Enchanted Riposte до 300, Verfire до 380, Verstone до380, Enchanted Zwerchhau до 170, Fleche до 480, Enchanted Redoublement до 170, Contre Sixte до 420, Verflare до 650, Verholy до 650, Enchanted Reprise до 420, Scorch до 750, Veraero III до 440, Verthunder III до 440 и Resolution до 850.',
      },
      // Trait 16 NEW
      "Trait 16": {
      ...
      "PVP Skill 01": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 6,000.<br/>Дополнительный эффект: накладывает эффект Dualcast<br/>Продолжительность: 15 сек.<br/><br/>※Умение меняется на Grand Impact после использования.',
      },
      // PVP Skill 02
      "PVP Skill 02": {
         "name": 'Enchanted Riposte',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 5,000.<br/>Игнорирует эффекты Guard при нанесении урона.<br/>Дополнительный эффект: создает вокруг персонажа барьер, поглощающий урон, равный силе лечения 4,000<br/>Продолжительность: 6 сек.<br/><br/>※Умение меняется на Enchanted Zwerchhau после использования.',
      },
      // PVP Skill 03
      "PVP Skill 03": {
         "name": 'Resolution',
         ...
         "radius_img": 'R6',
         "radius": '25y',
         "content": 'Удар, наносящий нестихийный урон по всем противникам по прямой линии перед персонажем с силой атаки 8,000.<br/>Дополнительный эффект: безмолвие (silence)<br/>Продолжительность: 2 сек.<br/>Этот умение не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Embolden',
         ...
         "radius_img": 'R2',
         "radius": '30y',
         "content": 'Увеличивает урон, наносимый персонажем и ближайшими сопартийцами на 8%, а также снижает получаемый урон на 8%.<br/>Продолжительность: 8 сек.<br/>Дополнительный эффект: накладывает эффект Prefulgence Ready<br/>Продолжительность: 15 сек.<br/><br/>※Умение меняется на Prefulgence после использования.',
      },
      // PVP Skill 05
      "PVP Skill 05": {
         "name": 'Corps-a-corps',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Рывок к цели, наносящий урон с силой атаки 3,000.<br/>Дополнительный эффект: накладывает на цель эффект Monomachy<br/>Эффект Monomachy: увеличивает наносимый урон по цели на 10% и снижает получаемый урон от нее на 10%<br/>Продолжительность: 8 сек.<br/>Максимум зарядов: 2<br/>Невозможно использовать, если персонаж находится под эффектами ограничивающими перемещение.',
      },
      // PVP Skill 06
      "PVP Skill 06": {
         "name": 'Displacement',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 3,000.<br/>Дополнительный эффект: прыжок назад на 15 ялмов<br/>Дополнительный эффект: увеличивает наносимый урон и силу лечения следующего заклинания на 15%<br/>Продолжительность: 10 сек.<br/>Максимум зарядов: 2<br/>Невозможно использовать, если персонаж находится под эффектами ограничивающими перемещение.',
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'Forte',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Создает вокруг персонажа барьер, снижающий получаемый урон на 50% и поглощающий урон, равный силе лечения 4,000.<br/>Продолжительность: 4 сек.<br/>Накладывает Thorned Flourish, когда барьер полностью поглощен.<br/>Продолжительность: 10 сек.<br/><br/>※Умение меняется на Vice of Thorns под действием эффекта Thorned Flourish.',
      },
      // PVP Skill 08
      "PVP Skill 08": {
         "name": 'Grand Impact',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и всем ближайшим противникам с силой 6,000 для первого и 4,000 для всех остальных.<br/>Может быть использовано только под действием эффекта Dualcast.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 09
      "PVP Skill 09": {
         "name": 'Enchanted Zwerchhau',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 6,000.<br/>Игнорирует эффекты Guard при нанесении урона.<br/>Комбо умение: Enchanted Riposte<br/>Дополнительный эффект: создает барьер вокруг персонажа, поглощающий урон, равный силе лечения 4,000<br/>Продолжительность: 6 сек.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Умение меняется на Enchanted Redoublement после использования.',
      },
      // PVP Skill 10
      "PVP Skill 10": {
         "name": 'Enchanted Redoublement',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 7,000.<br/>Игнорирует эффекты Guard при нанесении урона.<br/>Комбо умение: Enchanted Zwerchhau<br/>Дополнительный эффект: создает барьер вокруг персонажа, поглощающая урон, равный силе лечения 4,000<br/>Продолжительность: 6 сек.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Умение меняется на Scorch после использования.',
      },
      // PVP Skill 11
      "PVP Skill 11": {
         "name": 'Scorch',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и всем ближайшим противникам с силой атаки 8,000.<br/>Комбо умение: Enchanted Redoublement<br/>Дополнительный эффект: периодический урон<br/>Сила атаки: 4,000<br/>Продолжительность: 6 сек.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 12
      "PVP Skill 12": {
         "name": 'Prefulgence',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и всем ближайшим противникам с силой атаки 10,000.<br/>Дополнительный эффект: восстанавливает HP персонажа<br/>Сила лечения: 10,000<br/>Дополнительный эффект: восстанавливает HP сопартийцев, находящихся рядом с целью<br/>Сила лечения: 10,000<br/>Можно использовать только под действием эффекта Prefulgence.',
      },
      // PVP Skill 13
      "PVP Skill 13": {
         "name": 'Vice of Thorns',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и всем ближайшим противникам с силой атаки 4,000.<br/>Дополнительный эффект: stun (оглушение)<br/>Продолжительность: 2 сек.<br/>Можно использовать только под действием эффекта Thorned Flourish.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill LB
      "PVP Skill LB": {
         "name": 'Southern Cross',
         ...
         "radius_img": 'R10',
         "radius": '15y',
         "content": 'Накладывает метку в виде большого креста на земле под сопартийцем или противником, восстанавливая HP всем ближайшим сопартийцам и нанося урон противникам.<br/>Сила лечения: 12,000<br/>Сила атаки: 12,000<br/>Цели, находящиеся в середине метки, получат двойной эффект от этого действия.<br/>Может быть выполнено только тогда, когда шкала лимит брейка (limit gauge) заполнена.<br/>Время зарядки шкалы: 90 сек.',
      },
   };
   FILL_DB_VALUES(db);
   FILL_DB_SKILLS(db);
