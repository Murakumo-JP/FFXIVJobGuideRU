(() =>{
   let db = {
      ...
      "PVE Skill 04": {
         ...
         "radius_img": 'R2',
         "radius": "5y",
         "content": 'Удар, наносящий урон с силой атаки 120 по всем окружающим противникам.<br>Дополнительный эффект: повышает уровень угрозы',
      },
      // PVE Skill 05
      "PVE Skill 05": {
         "name": 'Shield Bash',
      ...
      "PVE Skill 14": {
         ...
         "radius_img": 'R1',
         "radius": "0y",
         "content": 'Забирает весь урон направленный на сопартийца, до тех пор, пока он находится в радиусе 20 ялмов.<br>Не срабатывает на некоторые атаки.<br>Продолжительность: 12 сек.<br>Стоимость: 50 Oath Gauge',
      },
      // PVE Skill 15
      "PVE Skill 15": {
      ...
      "PVE Skill 21": {
         ...
         "radius_img": 'R1',
         "radius": "0y",
         "content": 'Удар, наносящий урон с силой атаки 200.<br>Комбо умение: Riot Blade<br>Сила в комбо: 460<br>Комбо бонус: накладывает эффект Atonement Ready<br>Продолжительность: 30 сек.<br>Комбо бонус: накладывает эффект Divine Might<br>Эффект Divine Might: позволяет применить Holy Spirit or Holy Circle с повышенной силой атаки. Эффект пропадает после использования<br>Продолжительность: 30 сек.',
      },
      // PVE Skill 22
      "PVE Skill 22": {
         "name": 'Intervention',
      ...
      "PVE Skill 23": {
         ...
         "radius_img": 'R1',
         "radius": "0y",
         "content": 'Удар, наносящий нестихийный урон с силой атаки 400.<br>Сила атаки под эффектом Divine Might: 500<br>Сила атаки под эффектом Requiescat: 700<br>Эффект Divine Might будет иметь приоритет над эффектом Requiescat при нахождении под действием обоих.<br>Дополнительный эффект: восстанавливает HP персонажа<br>Сила лечения: 400',
      },
      // PVE Skill 24
      "PVE Skill 24": {
         "name": 'Intervene',
      ...
      "PVE Skill 26": {
         ...
         "radius_img": 'R3',
         "radius": "8y",
         "content": 'Создаёт область, в виде конуса позади персонажа, снижающую урон. На время действия увеличивает шанс блока до 100%, а также снижает нанесенный урон вашим сопартийцам на 15%. Эффект активен только если сопартийцы находятся в области действия умения.<br>Продолжительность: 18 сек.<br>Эффект спадет при использовании умений или перемещении персонажа (включая разворот в другие стороны).<br>Прерывает авто атаки при использовании умения.',
      },
      // PVE Skill 27
      "PVE Skill 27": {
         "name": 'Holy Circle',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 100 по всем окружающим противникам.<br>Сила атаки под эффектом Divine Might: 250<br>Сила атаки под эффектом Requiescat: 350<br>Эффект Divine Might будет иметь приоритет над эффектом Requiescat, при нахождении под действием обоих<br>Дополнительный эффект: восстанавливает HP персонажа<br>Сила лечения: 400',
      },
      // PVE Skill 28
      "PVE Skill 28": {
         "name": 'Atonement',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 460.<br>Дополнительный эффект: восстанавливает MP<br>Накладывает эффект Supplication Ready<br>Продолжительность: 30 сек.<br>Умение может быть выполнено только под действием эффекта Atonement Ready.',
      },
      // PVE Skill 29 NEW
      "PVE Skill 29": {
         "name": 'Supplication',
      ...
      "PVE Skill 30": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 540.<br>Дополнительный эффект: восстанавливает MP<br>Может быть использовано только под действием эффекта Sepulcher Ready.<br><br>※Это умение нельзя поместить на хотбар.<br>※Supplication меняется на Sepulcher при соблюдении требований к выполнению.',
      },
      // PVE Skill 31
      "PVE Skill 31": {
         "name": 'Confiteor',
      ...
      "PVE Skill 34": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и по всем окружающим противникам с силой 260 для первого и на 60% меньше для всех остальных.<br>Сила атаки под эффектом Requiescat: 760<br>Комбо умение: Confiteor<br>Дополнительный эффект: восстанавливает HP персонажа<br>Сила лечения: 400<br><br>※Это умение нельзя поместить на хотбар.<br>※Confiteor меняется на Blade of Faith при соблюдении требований к выполнению.',
      },
      // PVE Skill 35
      "PVE Skill 35": {
         "name": 'Blade of Truth',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и по всем окружающим противникам с силой 380 для первого и на 60% меньше для всех остальных.<br>Сила атаки под эффектом Requiescat: 880<br>Комбо умение: Blade of Faith<br>Дополнительный эффект: восстанавливает HP персонажа<br>Сила лечения: 400<br><br>※Это умение нельзя поместить на хотбар.<br>※Blade of Faith меняется на Blade of Truth при соблюдении требований к выполнению.',
      },
      // PVE Skill 36
      "PVE Skill 36": {
         "name": 'Blade of Valor',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и по всем окружающим противникам с силой 500 для первого и на 60% меньше для всех остальных.<br>Сила атаки под эффектом Requiescat: 1,000<br>Комбо умение: Blade of Truth<br>Дополнительный эффект: восстанавливает HP персонажа<br>Сила лечения: 400<br>Дополнительный эффект: накладывает эффект Blade of Honor Ready<br>Продолжительность: 30 сек.<br><br>※Это умение нельзя поместить на хотбар.<br>※Blade of Truth меняется на Blade of Valor при соблюдении требований к выполнению.',
      },
      // PVE Skill 37 NEW
      "PVE Skill 37": {
         "name": 'Guardian',
      ...
      "PVP Skill 02": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 6,000.<br/>Комбо умение: Fast Blade<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 03
      "PVP Skill 03": {
         "name": 'Royal Authority',
      ...
      "PVP Skill 04": {
         ...
         "radius_img": 'R4',
         "radius": '8y',
         "content": 'Удар, наносящий урон с силой атаки 8,000 всем противникам в конусе перед персонажем.<br/>Дополнительный эффект: увеличивает получаемый целью урон на 10%.<br/>Продолжительность: 10 сек.<br/>Уменьшает вдвое защитный бонус Guard, когда под его действием целью выбран противник.<br/>Этот боевой навык не имеет общего время восстановления с другими умениями.',
      },
      // PVP Skill 05 NEW
      "PVP Skill 05": {
         "name": 'Holy Spirit',
      ...
      "PVP Skill 06": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и по всем окружающим противникам с силой атаки 4,000.<br/>Дополнительный эффект: накладывает на цель эффект Sacred Claim.<br/>Эффект Sacred Claim: восстанавливает HP при успешной атаке по цели под этим эффектом<br/>Сила лечения: 3,000<br/>Продолжительность: 10 сек.<br/>Дополнительный эффект: накладывает эффект Atonement Ready<br/>Продолжительность: 15 сек.<br/>Дополнительный эффект: накладывает эффект Confiteor Ready<br/>Продолжительность: 15 сек.<br/><br/>※Умения меняется на Confiteor после использования.<br/>※Комбо Royal Authority меняется на Atonement, пока находится под действием эффекта Atonement Ready.',
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'Intervene',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Рывок к цели, наносящий урон с силой атаки 2,000.<br/>Дополнительный эффект: оглушение (stun)<br/>Продолжительность: 2 сек.<br/>Невозможно использовать, если персонаж находится под эффектами, ограничивающими перемещение.',
      },
      // PVP Skill 08
      "PVP Skill 08": {
         "name": 'Holy Sheltron',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": `Накладывает на персонажа эффекты Holy Sheltron and Knight's Resolve.<br/>Эффект Holy Sheltron: создает барьер вокруг персонажа, который поглощает урон, равный исцелению силой 8,000<br/>Продолжительность: 4 сек.<br/>Если барьер не разрушен к моменту истечения эффекта, то он наносит стихийный урон всем окружающим противникам с силой атаки, равной 150% от оставшейся прочности барьера и накладывает эффект Sword Oath на персонажа.<br/>Эффект Sword Oath: увеличивает наносимый урон на 15%<br/>Продолжительность: 8 сек.<br/>Дополнительный эффект: тяжесть (heavy) +75%<br/>Продолжительность: 4 сек.<br/>Накладывает эффект Shield Oath, когда барьер полностью поглощен.<br/><br/>Эффект Shield Oath: снижает получаемый урон на 15%<br/>Продолжительность: 8 сек.`,
      },
      // PVP Skill 09
      "PVP Skill 09": {
         "name": 'Guardian',
      ...
      "PVP Skill 10": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 9,000.<br/>Дополнительный эффект: накладывает эффект Supplication Ready<br/>Продолжительность: 15 сек.<br/>Может быть использовано только под действием эффекта Atonement Ready.<br/><br/>※Умения меняется на Supplication после использования.※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 11 NEW
      "PVP Skill 11": {
         "name": 'Supplication',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 10,000.<br/>Дополнительный эффект: накладывает эффект Sepulchre Ready<br/>Продолжительность: 15 сек.<br/>Может быть использовано только под действием эффекта Supplication Ready.<br/><br/>※Умения меняется на Sepulchre после использования.※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 12 NEW
      "PVP Skill 12": {
         "name": 'Sepulchre',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 11,000.<br/>Может быть использовано только под действием эффекта Sepulchre Ready.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 13 NEW
      "PVP Skill 13": {
         "name": 'Confiteor',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 10,000 по цели и всем противника рядом с ней.<br/>Дополнительный эффект: восстановливает HP персонажа<br/>Сила лечения: 8,000<br/>Может быть использовано только под действием эффекта Confiteor Ready.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 14
      "PVP Skill 14": {
         "name": 'Blade of Faith',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 11,000 по цели и всем противникам рядом с ней.<br/>Дополнительный эффект: восстановливает HP персонажа<br/>Сила лечения: 8,000<br/>Возможно использовать только под действием умения Blade of Faith Ready.<br/><br/>※Умения меняется на Blade of Truth после использования.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 15
      "PVP Skill 15": {
         "name": 'Blade of Truth',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 12,000 по цели и всем противникам рядом с ней.<br/>Дополнительный эффект: восстановливает HP персонажа<br/>Сила лечения: 8,000<br/>Комбо умение: Blade of Faith<br/><br/>※Умения меняется на Blade of Valor после использования.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 16
      "PVP Skill 16": {
         "name": 'Blade of Valor',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 13,000 по цели и всем противникам рядом с ней.<br/>Дополнительный эффект: восстановливает HP персонажа<br/>Сила лечения: 8,000<br/>Комбо умение: Blade of Truth<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 17
      "PVP Skill LB": {
         "name": 'Phalanx',
