(() =>{
   let db = {
      ...
      "PVP Skill 08": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": `Накладывает на персонажа эффекты Holy Sheltron and Knight's Resolve.<br/>Эффект Holy Sheltron: создает барьер вокруг персонажа, который поглощает урон, равный исцелению силой 10,000<br/>Продолжительность: 4 сек.<br/>Если барьер не разрушен к моменту истечения эффекта, то он наносит стихийный урон всем окружающим противникам с силой атаки, равной 100% от оставшейся прочности барьера и накладывает эффект Sword Oath на персонажа.<br/>Эффект Sword Oath: увеличивает наносимый урон на 10%<br/>Продолжительность: 8 сек.<br/>Дополнительный эффект: тяжесть (heavy) +75%<br/>Продолжительность: 4 сек.<br/>Накладывает эффект Shield Oath, когда барьер полностью поглощен.<br/><br/>Эффект Shield Oath: снижает получаемый урон на 20%<br/>Продолжительность: 8 сек.`,
      },
      // PVP Skill 09
      "PVP Skill 09": {
         "name": 'Guardian',
