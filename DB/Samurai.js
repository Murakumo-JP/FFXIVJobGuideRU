(() =>{
   let db = {
      ...
      "PVE Skill 02": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 140.<br/>Комбо умение: Gyofu<br/>Сила в комбо: 300<br/>Комбо бонус: накладывает Fugetsu<br/>Эффект Fugetsu: увеличивает наносимый урон на 13%<br/>Продолжительность: 40 сек.<br/>Комбо бонус: восполняет шкалу Kenki Gauge на 5',
      },
      // PVE Skill 03
      "PVE Skill 03": {
         "name": 'Third Eye',
      ...
      "PVE Skill 05": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 140.<br/>Комбо умение: Gyofu<br/>Сила в комбо: 300<br/>Комбо бонус: накладывает Fuka<br/>Эффект Fuka: уменьшает время длительности применения и время восстановления боевых навыков и заклинаний, а также промежуток между авто атаками на 13%.<br/>Продолжительность: 40 сек.<br/>Комбо бонус: восполняет шкалу Kenki Gauge на 5',
      },
      // PVE Skill 06
      "PVE Skill 06": {
         "name": 'Fuga',
      ...
      "PVE Skill 07": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 160, при выполнении удара в спину цели 210.<br/>Комбо умение: Jinpu<br/>Сила в комбо: 370<br/>Сила в комбо в спину цели: 420<br/>Комбо бонус: восполняет Kenki Gauge на 10<br/>Комбо бонус: активирует Getsu',
      },
      // PVE Skill 08
      "PVE Skill 08": {
         "name": 'Iaijutsu',
      ...
      "PVE Skill 10": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 160, при выполнении удара в бок цели 210.<br/>Комбо эффект: Shifu<br/>Сила в комбо: 370<br/>Сила в комбо в бок цели: 420<br/>Комбо бонус: восполняет Kenki Gauge на 10<br/>Комбо бонус: активирует  Ka',
      },
      // PVE Skill 11
      "PVE Skill 11": {
         "name": 'Oka',
      ...
      "PVE Skill 12": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 160.<br/>Комбо умение: Gyofu<br/>Сила в комбо: 340<br/>Комбо бонус: восполняет Kenki Gauge на 15<br/>Комбо бонус: активирует  Setsu',
      },
      // PVE Skill 13
      "PVE Skill 13": {
         "name": 'Meikyo Shisui',
      ...
      "PVE Skill 18": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 100 по всем ближайшим противникам.<br/>Стоимость: 25 Kenki Gauge',
      },
      // PVE Skill 19
      "PVE Skill 19": {
         "name": 'Hagakure',
      ...
      "PVE Skill 21": {
         ...
         "radius_img": 'R6',
         "radius": '10y',
         "content": 'Удар, наносящий урон по всем противникам по прямой линии перед персонажем с силой атаки 400 для первого и на 25% меньше для остальных.<br/>Стоимость: 25 Kenki Gauge<br/>Имеет общее время восстановления с умением Hissatsu: Senei.',
      },
      // PVE Skill 22
      "PVE Skill 22": {
         "name": 'Hissatsu: Senei',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 800.<br/>Стоимость: 25 Kenki Gauge<br/>Имеет общее время восстановления с умением Hissatsu: Guren.',
      },
      // PVE Skill 23
      "PVE Skill 23": {
         "name": 'Tsubame-gaeshi',
      ...
      "PVE Skill 24": {
         ...
         "radius_img": 'R6',
         "radius": '10y',
         "content": 'Удар, наносящий нестихийный урон по прямой линии по всем противникам перед персонажем с силой атаки 640 для первого и на 50% меньше для остальных.<br/>Может использоваться после накопления трех стаков Meditation после использования Iaijutsu, Meditate или Ogi Namikiri во время боя.<br/>Эффект Meditation пропадает после использования.',
      },
      // PVE Skill 25 NEW
      "PVE Skill 25": {
         "name": 'Tengetsu',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": "Уменьшает количество урона, наносимого следующей атакой, на 10%.<br/>Продолжительность: 4 сек.<br/>Дополнительный эффект: накладывает эффект Tengetsu's Foresight и восполняет шкалу Kenki Gauge на 10 при попадании.<br/>Эффект Tengetsu's Foresight: постепенно восстанавливает HP персонажа и снижает получаемый урон на 10%<br/>Продолжительность: 9 сек.<br/>Сила лечения: 200",
      },
      // PVE Skill 26
      "PVE Skill 26": {
         "name": 'Fuko',
      ...
      "PVE Skill 27": {
         ...
         "radius_img": 'R4',
         "radius": '8y',
         "content": 'Удар, наносящий критический (critical) урон по всем противникам в конусе перед персонажем с силой атаки 1,000 для первого и на 50% меньше для остальным.<br/>Наносимый урон увеличивается под действием эффектов, повышающего вероятность критического (critical) урона.<br/>Накладывает стак Meditation, вплоть до 3 стаков.<br/>Можно использовать только под действием эффекта Ogi Namikiri Ready.',
      },
      // PVE Skill 28
      "PVE Skill 28": {
         ...
         "radius_img": 'R4',
         "radius": '8y',
         "content": 'Удар, наносящий критический (critical) урон по всем противникам в конусе перед персонажем с силой атаки 1,000 для первого и на 50% меньше для остальным.<br/>Наносимый урон увеличивается под действием эффектов, повышающего вероятность критического (critical) урона.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Iaijutsu меняется на Kaeshi: Namikiri при соблюдении требований к выполнению.',
      },
      // PVE Skill 29 NEW
      "PVE Skill 29": {
         "name": 'Gyofu',
      ...
      "PVE Skill 30": {
         ...
         "radius_img": 'R4',
         "radius": '8y',
         "content": 'Удар, наносящий урон по всем противникам в конусе перед персонажем с силой атаки 940 для первого и на 50% меньше для остальным.<br/>Стоимость: 50 Kenki Gauge<br/>Можно использовать только под действием эффекта Zanshin Ready.',
      },
      // Jyutsu 01
      "Jyutsu 01": {
         "name": 'Higanbana',
      ...
      "Jyutsu 03": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий критический (critical) урон с силой атаки 640.<br/>Наносимый урон увеличивается под действием эффектов, повышающего вероятность критического (critical) урона.<br/>Дополнительный эффект: накладывает стак Meditation, максимум 3<br/>Может быть использовано только после накопления 3 Sen.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Iaijutsu меняется на Midare Setsugekka при соблюдении требований к выполнению.',
      },
      // Jyutsu 04
      "Jyutsu 04": {
         "name": 'Kaeshi: Goken',
      ...
      "Jyutsu 05": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий критический (critical) урон с силой атаки 640.<br/>Наносимый урон увеличивается под действием эффектов, повышающего вероятность критического (critical) урона.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Iaijutsu меняется на Kaeshi: Setsugekka при соблюдении требований к выполнению.',
      },
      // Jyutsu 06 NEW
      "Jyutsu 06": {
         "name": 'Tendo Goken',
      ...
      "Jyutsu 08": {
         ...
         "radius_img": 'R2',
         "radius": '8y',
         "content": 'Удар, наносящий урон с силой атаки 410 по всем окружающим противникам.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Iaijutsu меняется на Tendo Kaeshi Goken при соблюдении требований к выполнению.',
      },
      // Jyutsu 09 NEW
      "Jyutsu 09": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий критический (critical) урон с силой атаки 1,100.<br/>Наносимый урон увеличивается под действием эффектов, повышающего вероятность критического (critical) урона.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Tsubame-gaeshi меняется на Tendo Kaeshi Setsugekka при соблюдении требований к выполнению.',
      },
      // Trait 01
      "Trait 01": {
         "name": 'Kenki Mastery',
      ...
      "Trait 04": {
         ...
         "job_icon": 'SAM',
         "level": '74',
         "content": 'Уменьшает время использования Iaijutsu до 1.3 сек.<br/>Дополнительный эффект: накладывает эффект Tsubame-gaeshi Ready<br/>Продолжительность: 30 сек.',
      },
      // Trait 05 NEW
      "Trait 05": {
      ...
      "Trait 13": {
         ...
         "job_icon": 'SAM',
         "level": '94',
         "content": 'Увеличивает силу атаки Jinpu до 140, Shifu до 140, Enhanced Enpi до 270, Gekko до 160, Higanbana урон с течением времени до 50, Kasha до 160, Yukikaze до 160, Midare Setsugekka до 640, Kaeshi: Setsugekka до 640, Shoha до 640, Ogi Namikiri до 1,000 и Kaeshi: Namikiri до 1,000.',
      },
      // Trait 14 NEW
      "Trait 14": {
      ...
      "PVP Skill 01": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 6,000.<br/><br/>※Умение меняется на Hyosetsu под действием эффекта Kaiten.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 02
      "PVP Skill 02": {
         "name": 'Gekko',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 6,000.<br/>Комбо умение: Yukikaze или Hyosetsu<br/><br/>※Умение меняется на Mangetsu под действием эффекта Kaiten.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 03
      "PVP Skill 03": {
         "name": 'Kasha',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 6,000.<br/>Комбо умение: Gekko или Mangetsu<br/><br/>※Умение меняется на Oka под действием эффекта Kaiten.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Ogi Namikiri',
         ...
         "radius_img": 'R4',
         "radius": '8y',
         "content": 'Удар, наносящий урон по всем противникам в конусе перед персонажем с силой атаки 8,000.<br/>Сила атаки увеличивается на 12,000, если атаковать только одну цель.<br/>Дополнительный эффект: при атаке двух или более целей создает вокруг персонажа барьер, поглощающий урон, равный силе лечения 8,000<br/>Продолжительность: 10 сек.<br/>Этот боевой навык не имеет общего времени восстановления с другими умениями.<br/><br/>※Умение меняется на Kaeshi: Namikiri после использования.',
      },
      // PVP Skill 05
      "PVP Skill 05": {
         "name": 'Hissatsu: Soten',
      ...
      "PVP Skill 06": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Снижает получаемый урон на 25% и наносит контрудар с силой атаки 4,000 каждый раз, когда персонаж получает урон.<br/>Продолжительность: 4 сек.<br/>Дополнительный эффект: накладывает на цель эффект Kuzushi<br/>Эффект Kuzushi: увеличивает наносимый цели урон на 20%<br/>Продолжительность: 4 сек.<br/>Дополнительный эффект: накладывает эффект Zanshin Ready<br/>Продолжительность: 20 сек.<br/><br/>※Умение меняется на Zanshin после использования.',
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'Mineuchi',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 2,000.<br/>Дополнительный эффект: накладывает на цель эффект Debana<br/>Эффект Debana: увеличивает наносимый цели урон на 10%<br/>Продолжительность: 4 сек.<br/>Увеличивает продолжительность Kuzushi на 4 сек., до максимума 6 сек. Эффект не складывается с Kuzushi при увеличении его продолжительности.<br/>Дополнительный эффект: stun (оглушение)<br/>Продолжительность: 2 сек.',
      },
      // PVP Skill 08
      "PVP Skill 08": {
         "name": 'Meikyo Shisui',
      ...
      "PVP Skill 09": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 6,000 по всем ближайшим противникам.<br/>Дополнительный эффект: связывание (bind)<br/>Продолжительность: 2 сек.<br/>Можно использовать только под действием эффекта Kaiten.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 10
      "PVP Skill 10": {
         "name": 'Mangetsu',
      ...
      "PVP Skill 11": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 8,000 по всем ближайшим противникам.<br/>Комбо умение: Gekko или Mangetsu<br/>Можно использовать только под действием эффекта Kaiten.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 12
      "PVP Skill 12": {
         "name": 'Kaeshi: Namikiri',
         ...
         "radius_img": 'R4',
         "radius": '8y',
         "content": 'Удар, наносящий урон по всем противникам в конусе перед персонажем с силой атаки 8,000.<br/>Сила атаки увеличивается до 12,000, если атаковать только одну цель.<br/>Комбо умение: Ogi Namikiri<br/>Дополнительный эффект: при атаке двух или более целей создает вокруг персонажа барьер, поглощающий урон, равный силе лечения 8,000<br/>Продолжительность: 10 сек.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 13
      "PVP Skill 13": {
         "name": 'Zanshin',
         ...
         "radius_img": 'R4',
         "radius": '8y',
         "content": 'Удар, наносящий урон по всем противникам в конусе перед персонажем с силой атаки 6,000.<br/>Дополнительный эффект: поглощает 100% нанесенного урона в виде HP<br/>Можно использовать только под действием эффекта Tendo Setsugekka Ready.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 14
      "PVP Skill 14": {
         "name": 'Tendo Setsugekka',
      ...
      "PVP Skill LB": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Стремительно прыгает вперед, нанося урон по цели и всем ближайшим противникам с силой атаки 24,000.<br/>Если цель находится под эффектом Kuzushi, то умение наносит урон, равный 100% ее максимального HP.<br/>При нанесении урона игнорирует эффекты Guard.<br/>Дополнительный эффект Kuzushi не действует на неигровых персонажей, игроков под действием Guard или находящихся в роботах.<br/>Может быть выполнено только тогда, когда шкала лимит брейка (limit gauge) заполнена.<br/>Время зарядки шкалы: 120 сек.<br/>Невозможно использовать, если персонаж находится под эффектами ограничивающими перемещение.',
      },
   };
   FILL_DB_VALUES(db);
   FILL_DB_SKILLS(db);
