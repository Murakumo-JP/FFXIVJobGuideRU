(() =>{
   let db = {
      ...
      "Jyutsu 09": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий критический (critical) урон с силой атаки 1,020.<br/>Наносимый урон увеличивается под действием эффектов, повышающего вероятность критического (critical) урона.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Tsubame-gaeshi меняется на Tendo Kaeshi Setsugekka при соблюдении требований к выполнению.',
      },
      // Trait 01
      "Trait 01": {
         "name": 'Kenki Mastery',
      ...
      "PVP Skill 13": {
         ...
         "radius_img": 'R4',
         "radius": '8y',
         "content": 'Удар, наносящий урон по всем противникам в конусе перед персонажем с силой атаки 5,000.<br/>Дополнительный эффект: поглощает 100% нанесенного урона в виде HP<br/>Можно использовать только под действием эффекта Tendo Setsugekka Ready.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 14
      "PVP Skill 14": {
         "name": 'Tendo Setsugekka',
