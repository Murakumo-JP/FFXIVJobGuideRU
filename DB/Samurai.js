(() =>{
   let db = {
      ...
      "PVE Skill 29": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 230.<br/>Дополнительный эффект: восполняет шкалу Kenki Gauge на 5',
      },
      // PVE Skill 30 NEW
      "PVE Skill 30": {
         "name": 'Zanshin',
         ...
         "radius_img": 'R4',
         "radius": '8y',
         "content": 'Удар, наносящий урон по всем противникам в конусе перед персонажем с силой атаки 820 для первого и на 60% меньше для остальным.<br/>Стоимость: 50 Kenki Gauge<br/>Можно использовать только под действием эффекта Zanshin Ready.',
      },
      // Jyutsu 01
      "Jyutsu 01": {
         "name": 'Higanbana',
