(() =>{
   let db = {
      ...
      "PVE Skill 30": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 370<br/>Дополнительный эффект: восстанавливает HP цели, находящейся под эффектом Kardion, наложенным персонажем<br/>Сила лечения: 170',
      },
      // PVE Skill 31
      "PVE Skill 31": {
         "name": 'Phlegma III',
      ...
      "PVE Skill 35": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и всем окружающим противникам с силой атаки 370 для первого и на 50% меньше для остальных.<br/>Дополнительный эффект: восстанавливает HP цели, находящейся под эффектом Kardion, наложенным персонажем<br/>Сила лечения: 170<br/>Стоимость: 1 Addersting',
      },
      // PVE Skill 36
      "PVE Skill 36": {
         "name": 'Krasis',
      ...
      "Trait 14": {
         ...
         "job_icon": 'SGE',
         "level": '94',
         "content": 'Увеличивает силу атаки Dosis III до 370, Toxikon II до 370 и Pneuma до 370.',
      },
      // Trait 15 NEW
      "Trait 15": {
      ...
      "PVP Skill 01": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 6,000.<br/>Дополнительный эффект: восстанавливает HP цели, находящейся под эффектом Kardion, наложенным персонажем<br/>Сила лечения: 4,000',
      },
      // PVP Skill 02
      "PVP Skill 02": {
         "name": 'Phlegma III',
      ...
      "PVP Skill 03": {
         ...
         "radius_img": 'R6',
         "radius": '25y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 12,000 по всем противникам по прямой линии перед персонажем.<br/>Дополнительный эффект: накладывает эффект Haima и 3 стака Haimatinon на персонажа и всех сопартийцев в радиусе 20 ялмов<br/>Эффект Haima: создает магический барьер, который поглощает урон, равный силе лечению 4,000<br/>Продолжительность: 10 сек.<br/>Когда барьер полностью поглощает урон, расходуется стак Haimatinon и накладывается новый барьер.<br/>Когда действие эффекта истекает, накладывается исцеляющий эффект.<br/>Сила лечения: 4,000 за каждый стак Haimatinon<br/>Это умение не имеет общего времени восстановления с другими умениями. ',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Eukrasia',
      ...
      "PVP Skill 05": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Рывок в сторону выбранной цели.<br/>Максимум зарядов: 2<br/>Невозможно использовать, если персонаж находится под эффектами ограничивающими перемещение.',
      },
      // PVP Skill 06
      "PVP Skill 06": {
         "name": 'Toxikon',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 2,000 по цели и всем окружающим противникам.<br/>Максимум зарядов: 2<br/>Дополнительный эффект: увеличивает получаемый целью урон на 10%<br/>Продолжительность: 6 сек.<br/>Максимум стаков: 2',
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'Kardia',
      ...
      "PVP Skill 08": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Периодический нестихийный урон.<br/>Сила атаки: 3,000<br/>Продолжительность: 12 сек.<br/>Дополнительный эффект: накладывает Eukrasian Diagnosis на цель, находящуюся под действием Kardion наложенным персонажем<br/>Эффект Eukrasian Diagnosis: создает магический барьер, который поглощает урон, равный лечению с силой 8,000<br/>Продолжительность: 12 сек.<br/>Накладывает Addersting, когда барьер полностью поглощен.<br/>Продолжительность: 15 сек.<br/><br/>※ Умение Toxikon меняется на Toxikon II под действиям эффекта Addersting.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 09
      "PVP Skill 09": {
         "name": 'Psyche',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 12,000 по цели и всем окружающим противникам.<br/>Сила атаки снижается вдвое для противников, находящихся на расстоянии более 3 ялмов от первой цели.<br/>Комбо умение: Phlegma III<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 10
      "PVP Skill 10": {
         "name": 'Toxikon II',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и всем окружающим противникам с силой атаки 8,000 для первого и 4,000 для остальных.<br/>Дополнительный эффект: увеличивает получаемый целью урон на 10%<br/>Продолжительность: 6 сек.<br/>Может быть выполнено только под эффектом Addersting.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill LB
      "PVP Skill LB": {
         "name": 'Mesotes',
