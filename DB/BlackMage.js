(() =>{
   let db = {
      ...
      "PVE Skill 01": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон льдом с силой атаки 180.<br/>Дополнительный эффект: накладывает эффект Umbral Ice или снимает эффект Astral Fire',
      },
      // PVE Skill 02
      "PVE Skill 02": {
         "name": 'Fire',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон огнем с силой атаки 180.<br/>Дополнительный эффект: накладывает эффект Astral Fire или снимает эффект Umbral Ice<br/>Дополнительный эффект: шанс 40% получить эффект Firestarter<br/>Эффект Firestarter: следующее заклинания Fire III будет бесплатным (не потребует MP) и будет использоваться мгновенно',
      },
      // PVE Skill 03
      "PVE Skill 03": {
         "name": 'Transpose',
      ...
      "PVE Skill 11": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон огнем с силой атаки 290.<br/>Дополнительный эффект: накладывает эффект Astral Fire III и снимает эффект Umbral Ice',
      },
      // PVE Skill 12
      "PVE Skill 12": {
         "name": 'Blizzard III',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон льдом с силой атаки 290.<br/>Дополнительный эффект: накладывает эффект Umbral Ice III и снимает эффект Astral Fire',
      },
      // PVE Skill 13
      "PVE Skill 13": {
         "name": 'Umbral Soul',
      ...
      "PVE Skill 18": {
         ...
         "radius_img": 'R2',
         "radius": '3y',
         "content": 'Создаёт круг силы вокруг персонажа, нахождение в котором снижает время применения и время восстановления заклинаний, а также задержку между авто атаками на 15%.<br/>Продолжительность: 20 сек.<br/>Максимум зарядов: 2<br/>Не может быть использовано под действием эффекта Ley Lines.',
      },
      // PVE Skill 19
      "PVE Skill 19": {
         "name": 'Blizzard IV',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон льдом с силой атаки 300.<br/>Дополнительный эффект: накладывает 3 Umbral Hearts<br/>Бонус Umbral Heart: предотвращает увеличение стоимости MP для заклинаний Astral Fire и снижает стоимость MP у заклинания Flare на одну треть<br/>Возможно использовать только под действием эффекта Umbral Ice.',
      },
      // PVE Skill 20
      "PVE Skill 20": {
         "name": 'Fire IV',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон огнем с силой атаки 300.<br/>Дополнительный эффект: активирует Astral Soul<br/>Эффект заканчивается, когда истекает действие Astral Fire.<br/>Заклинание может использоваться только под эффектом Astral Fire.',
      },
      // PVE Skill 21
      "PVE Skill 21": {
      ...
      "PVE Skill 24": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и всем противникам с силой атаки 600 для первого и на 25% меньше для всех остальных.<br/>Стоимость: 1 Polyglot',
      },
      // PVE Skill 25
      "PVE Skill 25": {
         "name": 'Despair',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон огнем с силой атаки 350.<br/>Дополнительный эффект: накладывает эффект Astral Fire III<br/>Возможно использовать только под действием эффекта Astral Fire.',
      },
      // PVE Skill 26
      "PVE Skill 26": {
         "name": 'Xenoglossy',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 890.<br/>Стоимость: 1 Polyglot',
      },
      // PVE Skill 27
      "PVE Skill 27": {
         "name": 'High Fire II',
      ...
      "PVE Skill 30": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 540.<br/>Бонус Astral Fire: накладывает эффект Firestarter<br/>Эффект Firestarter: следующий Fire III будет использован мгновенно и не расходует MP<br/>Бонус Umbral Ice: не требует MP для использования<br/>Может использоваться только под действием эффекта Paradox.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Fire и Blizzard меняется на Paradox при соблюдении требований к выполнению.',
      },
      // PVE Skill 31 NEW
      "PVE Skill 31": {
         "name": 'High Thunder',
      ...
      "PVE Skill 34": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон огнем по цели и всем ближайшим противникам с силой атаки 500 для первого противника и на 65% меньше для всех остальных.<br/>Возможно использовать только при полной шкале Astral Gauge.',
      },
      // Trait 01
      "Trait 01": {
         "name": 'Aspect Mastery',
         ...
         "job_icon": 'THM',
         "level": '1',
         "content": 'Использование персонажем определённых огненных и ледяных заклинаний дает стак Astral Fire and Umbral Ice.<br/>Максимум стаков: 1<br/>Пока персонаж находится под действием эффекта Astral Fire, сила атаки произнесенных заклинаний Fire увеличивается на 40%, стоимость произнесения заклинаний Fire удваивается, восстановление MP снижается до 0. Сила заклинаний Ice снижается на 10%.<br/>Пока персонаж находится под действием эффекта Umbral Ice, стоимость произнесения заклинаний Ice снижается до 0, при произнесении заклинания Ice восстанавливается 2,500 MP. Сила атаки заклинаний Fire снижается на 10%.',
      },
      // Trait 02
      "Trait 02": {
         "name": 'Maim and Mend',
      ...
      "Trait 06": {
         ...
         "job_icon": 'THM',
         "level": '42',
         "content": 'Дает 40% шанс, что после использования заклинания Fire, следующее заклинание Fire III не потребует MP и будет использовано мгновенно.',
      },
      // Trait 07
      "Trait 07": {
      ...
      "Trait 17": {
         ...
         "job_icon": 'BLM',
         "level": '86',
         "content": 'Усиливает увеличение магического урона Enochian до 22%.',
      },
      // Trait 18
      "Trait 18": {
      ...
      "Trait 21": {
         ...
         "job_icon": 'BLM',
         "level": '96',
         "content": 'Повышает урон от магии Enochian до 27%.',
      },
      // Trait 22 NEW
      "Trait 22": {
      ...
      "PVP Skill 03": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон молнией с силой атаки 15,000 по всем ближайшим противникам.<br/>Дополнительный эффект: создает барьер вокруг персонажа, поглощающий урон, равный силе лечения 15,000<br/>Продолжительность: 10 сек.<br/>Это умение не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Paradox',
      ...
      "PVP Skill 05": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 12,000.<br/>Дополнительный эффект: поглощает 50% нанесенного урона в виде HP<br/>Сила атаки снижается до 8,000, когда HP персонажа ниже 50%, но при этом поглощается 200% нанесенного урона в виде HP.<br/>Максимум зарядов: 2<br/>Это умение не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 06
      "PVP Skill 06": {
         "name": 'Lethargy',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Снижает наносимый целью урон на 33%.<br/>Продолжительность: 5 сек.<br/>Дополнительный эффект: тяжесть (heavy) +75%<br/>Продолжительность: 3 сек.',
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'Aetherial Manipulation',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Рывок в сторону выбранной цели.<br/>Невозможно использовать, если персонаж находится под эффектами ограничивающими перемещение.',
      },
      // PVP Skill 08
      "PVP Skill 08": {
