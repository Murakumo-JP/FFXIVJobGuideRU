(() =>{
   let db = {
      ...
      "PVP Skill 17": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Накладывает эффект Wreath of Fire.<br/>Эффект Wreath of Fire: удар, наносящий урон огнем с силой атаки 4,000 по цели и всем ближайшим противникам при произнесении заклинания<br/>Игнорирует эффекты Guard при нанесении урона.<br/>Продолжительность: 10 сек.<br/>Может быть использовано только под действием эффекта Astral Fire.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 18
      "PVP Skill 18": {
         "name": 'Wreath of Ice',
