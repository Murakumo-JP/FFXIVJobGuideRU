(() =>{
   let db = {
      ...
      "PVE Skill 16": {
         ...
         "radius_img": 'R2',
         "radius": '15y',
         "content": 'В указанном месте создает область, которая снижает получаемый урон. В течении действия эффекта сопартийца, находящиеся в зоне, получают на 10% меньше входящего урона, а их HP постоянно восстанавливается.<br/>Продолжительность: 15 сек.<br/>Дополнительный эффект: периодическое лечение (regen)<br/>Сила лечения: 100<br/>Дополнительный эффект: восполняет шкалу Faerie Gauge на 10<br/>Стоимость: 1 Aetherflow Gauge',
      },
      // PVE Skill 17
      "PVE Skill 17": {
         "name": 'Indomitability',
      ...
      "PVE Skill 27": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Периодический нестихийный урон.<br/>Сила атаки: 80<br/>Продолжительность: 30 сек.',
      },
      // PVE Skill 28
      "PVE Skill 28": {
         "name": 'Broil III',
      ...
      "Trait 11": {
         ...
         "job_icon": 'SCH',
         "level": '85',
         "content": 'Увеличивает силу лечения умений Physick до 450, Embrace до 180 и Seraphic Veil до 180.<br/>Увеличивает прочность барьеров умений Adloquium до 180% от восстановленного HP и Succor до 160% от восстановленного HP.',
      },
      // Trait 12
      "Trait 12": {
      ...
      "PVP Skill 01": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 6,000.',
      },
      // PVP Skill 02
      "PVP Skill 02": {
         "name": 'Adloquium',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Восстанавливает HP цели.<br/>Сила лечения: 4,000<br/>Дополнительный эффект: накладывает на цель Galvanize и Catalyze<br/>Эффект Galvanize: поглощает урон, равный силе лечения 4,000<br/>Продолжительность: 12 сек.<br/>Сила барьера удваивается, когда персонаж находится под действием Recitation.<br/>Эффект Catalyze: снижает получаемый урон на 10%<br/>Продолжительность: 12 сек.<br/>Максимум зарядов: 2<br/>Этот умение не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 03
      "PVP Skill 03": {
         "name": 'Biolysis',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Накладывает на цель Biolysis and Biolytic.<br/>Эффект Biolysis: периодический урон<br/>Сила атаки: 3,000<br/>Продолжительность: 12 сек.<br/>Сила атаки удваивается на 50%, когда персонаж находится под действием Recitation.<br/>Эффект Biolytic: уменьшает количество HP, восстанавливаемых целью умениями лечения на 20%<br/>Продолжительность: 12 сек.<br/>Этот умение не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Deployment Tactics',
         ...
         "radius_img": 'R2',
         "radius": '15y',
         "content": 'Распространяет эффекты Galvanize и Catalyze, примененный персонажем на себя или на сопартийца, на всех ближайших сопартийцев.<br/>При выборе противника распространяет эффекты Biolysis и Biolytic по всем окружающим противникам.<br/>Продолжительность: время, оставшееся от первоначального эффекта<br/>Не действует на цели, не находящиеся под эффектами, наложенными персонажем, неигровых персонажей или игроков, находящихся в роботах.<br/>Максимум зарядов: 2',
      },
      // PVP Skill 05
      "PVP Skill 05": {
         "name": 'Chain Stratagem',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Увеличивает получаемый целью урон на 10%.<br/>Продолжительность: 10 сек.<br/>Уменьшает вдвое защитный бонус Guard, когда под его действием целью выбран противник.',
      },
      // PVP Skill 06
      "PVP Skill 06": {
         "name": 'Expedient',
      ...
      "PVP Skill 07": {
         ...
         "radius_img": 'R1',
         "radius": '1y',
         "content": 'Призывает фею Seraph для сражения в указанную область.<br/>Продолжительность: 20 сек.<br/>Автоматически использует Seraphic Veil на ближайших сопартийцев в радиусе 30 ялмов.<br/>Автоматически накладывает эффект Seraphic Illumination на ближайших сопартийцев в радиусе 15 ялмов.<br/>Эффект Seraphic Illumination: увеличивает восстановление HP при использовании умений лечения персонажа на себя на 10%',
      },
      // PVP Skill 08
      "PVP Skill 08": {
         "name": 'Seraphic Halo',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 9,000 по цели и всем ближайшим противникам.<br/>Может быть использовано только под действием эффекта Seraphism.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 09
      "PVP Skill 09": {
         "name": 'Accession',
         ...
         "radius_img": 'R2',
         "radius": '15y',
         "content": 'Восстанавливает HP персонажа и всех ближайших сопартийцев.<br/>Сила лечения: 8,000<br/>Дополнительный эффект: создаёт магический барьер, который поглощает получаемый урон, равный равный силе лечения 8,000<br/>Продолжительность: 20 сек.<br/>Может быть использовано только под действием эффекта Seraphism.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 10
      "PVP Skill 10": {
         "name": 'Seraphic Veil',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Восстанавливает HP цели.<br/>Сила лечения: 6,000<br/>Дополнительный эффект: создаёт магический барьер, который поглощает получаемый урон, равный равный силе лечения 6,000<br/>Продолжительность: 10 сек.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill LB1
      "PVP Skill LB1": {
         "name": 'Seraphism',
         ...
         "radius_img": 'R2',
         "radius": '30y',
         "content": 'Накладывает эффект Seraphism и Recitation.<br/>Эффект Seraphism: Broil IV улучшается до Seraphic Halo и Seraphism улучшается до Accession<br/>Продолжительность: 20 сек.<br/>Эффект Recitation: увеличивает силу умения Adloquium и эффекты Biolysis<br/>Продолжительность: 20 сек.<br/>Дополнительный эффект: снимает с персонажа или с ближайшего сопартийца один статусный эффект, который может быть снят Purify. Если статусный эффект не был снят, создает барьер, который обнуляет следующий статусный эффект, который может быть снят Purify<br/>Продолжительность: 20 сек.<br/>Может быть выполнено только тогда, когда шкала лимит брейка (limit gauge) заполнена.<br/>Время зарядки шкалы: 90 сек.<br/><br/>※ Умением меняется на Accession после использования.',
      },
   };
   FILL_DB_VALUES(db);
   FILL_DB_SKILLS(db);
