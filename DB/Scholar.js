(() =>{
   let db = {
      ...
      "PVP Skill LB1": {
         ...
         "radius_img": 'R2',
         "radius": '30y',
         "content": 'Накладывает эффект Seraphism.<br/>Эффект Seraphism: Broil IV улучшается до Seraphic Halo и Seraphism улучшается до Accession<br/>Продолжительность: 20 сек.<br/>Дополнительный эффект: накладывает Seraph Flight на персонажа и всех ближайших сопартийцев<br/>Эффект Seraph Flight: создает барьер, который обнуляет следующий статусный эффект, который может быть снят Purify<br/>Продолжительность: 20 сек.<br/>Дополнительный эффект: накладывает эффект Recitation<br/>Эффект Recitation: увеличивает силу умения Adloquium и эффекты Biolysis<br/>Продолжительность: 20 сек.<br/>Может быть выполнено только тогда, когда шкала лимит брейка (limit gauge) заполнена.<br/>Время зарядки шкалы: 90 сек.<br/><br/>※ Умением меняется на Accession после использования.',
      },
   };
   FILL_DB_VALUES(db);
   FILL_DB_SKILLS(db);
