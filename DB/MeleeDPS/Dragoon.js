(() =>{
   let db = {
      ...
      "PVE Skill 04": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Дальний удар, наносящий урон с силой атаки 200.<br/>Сила атаки Enhanced Piercing Talon: 350',
      },
      // PVE Skill 05
      "PVE Skill 05": {
         "name": 'Disembowel',
      ...
      "PVE Skill 09": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Совершает прыжок на место, находящееся в 15 ялмах позади персонажа.<br/>Дополнительный эффект: накладывает эффект Enhanced Piercing Talon<br/>Продолжительность: 15 сек.<br/>Невозможно использовать, если персонаж находится под эффектами ограничивающими перемещение.',
      },
      // PVE Skill 10
      "PVE Skill 10": {
         "name": 'Doom Spike',
      ...
      "PVE Skill 20": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 380.<br/>Можно использовать только при Dive Ready.',
      },
      // PVE Skill 21
      "PVE Skill 21": {
         "name": 'Nastrond',
         ...
         "radius_img": 'R6',
         "radius": '15y',
         "content": 'Удар, наносящий физический урон по всем противникам по прямой линии перед персонажем с силой атаки 720 для первого и на 50% меньше для остальных.<br/>Может быть использовано только под действием эффекта Nastrond Ready.',
      },
      // PVE Skill 22
      "PVE Skill 22": {
      ...
      "PVE Skill 33": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и всем окружающим противникам с силой атаки 1,000 для первого и на 50% меньше для остальных.<br/>Может быть использовано только под действием эффекта Starcross Ready.',
      },
      // Trait 01
      "Trait 01": {
         "name": 'Enhanced Jump',
      ...
      "Trait 02": {
         ...
         "job_icon": 'DRG',
         "level": '70',
         "content": 'Улучшает Blood of the Dragon до Life of the Dragon.<br/>Эффект Life of the Dragon: увеличивает наносимый урон на 15%.<br/>При успешном использовании Geirskogul, дает Nastrond Ready.<br/>Продолжительность: 20 сек.',
      },
      // Trait 03
      "Trait 03": {
         "name": 'Jump Mastery',
      ...
      "Trait 04": {
         ...
         "job_icon": 'DRG',
         "level": '76',
         "content": 'Увеличивает силу атаки True Thrust до 230, Vorpal Thrust до 130, Piercing Talon до 200, Enhanced Piercing Talon до 350 и Disembowel до 140.<br/>Накладывает эффект Draconian Fire, если Drakesbane выполнено после Fang and Claw или Wheeling Thrust.<br/>Продолжительность: 30 сек.<br/>Эффект Draconian Fire заканчивается при выполнении любого боевого навыка ближнего боя.<br/>Улучшает True Thrust до Raiden Thrust, пока персонаж находится под эффектом Draconian Fire.',
      },
      // Trait 05
      "Trait 05": {
      ...
      "Trait 09": {
         ...
         "job_icon": 'DRG',
         "level": '90',
         "content": 'Увеличивает силу атаки Geirskogul до 280 и Nastrond до 720.<br/>Позволяет усилить Firstminds Focus при успешном использовании Raiden Thrust или Draconian Fury, вплоть до 2 зарядов.',
      },
      // Trait 10
      "Trait 10": {
      ...
      "PVP Skill 02": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 6,000.<br/>Комбо умение: Raiden Thrust<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 03
      "PVP Skill 03": {
         "name": 'Wheeling Thrust',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 7,000.<br/>Комбо умение: Fang and Claw<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Drakesbane',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 8,000.<br/>Комбо умение: Wheeling Thrust<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 05
      "PVP Skill 05": {
         "name": 'Chaotic Spring',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 8,000.<br/>Игнорирует эффекты Guard при нанесении урона.<br/>Дополнительный эффект: поглощает 150% нанесенного урона в виде HP<br/>Этот боевой навык не имеет общее время восстановления с другими умениями.',
      },
      // PVP Skill 06
      "PVP Skill 06": {
         "name": 'Geirskogul',
         ...
         "radius_img": 'R6',
         "radius": '15y',
         "content": 'Удар, наносящий урон по всем противникам по прямой линии перед персонажем с силой атаки 4,000.<br/>Дополнительный эффект: накладывает эффект Life of the Dragon<br/>Эффект Life of the Dragon: увеличивает наносимый и получаемый урон на 25%<br/>Продолжительность: 10 сек.<br/>Дополнительный эффек: накладывает эффект Nastrond Ready<br/>Продолжительность: 10 сек.<br/>Дополнительный эффек: накладывает эффект Starcross Ready<br/>Продолжительность: 10 сек.<br/><br/>※При выполнении умение меняется на Nastrond.<br/>※Wheeling Thrust Combo меняется на Starcross под действием эффекта Starcross Ready.',
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'High Jump',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": "Удар с прыжком, наносящий урон с силой атаки 6,000.<br/>Дополнительный эффект: накладывает эффект Heavensent<br/>Продолжительность: 10 сек.<br/>Невозможно использовать, если персонаж находится под эффектами ограничивающими перемещение.<br/><br/>※Комбо Wheeling Thrust меняется на Heavens' Thrust под эффектом Heavensent.",
      },
      // PVP Skill 08
      "PVP Skill 08": {
         "name": 'Elusive Jump',
      ...
      "PVP Skill 09": {
         ...
         "radius_img": 'R2',
         "radius": '10y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 3,000 по всем ближайшим противникам.<br/>Эффект Horrid Roar: снижает наносимый персонажу урон на 50%<br/>Продолжительность: 10 сек.',
      },
      // PVP Skill 10
      "PVP Skill 10": {
         "name": "Heavens' Thrust",
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 10,000.<br/>Может быть выполнено только под эффектом Heavensent.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 11
      "PVP Skill 11": {
         "name": 'Starcross',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 12,000 по цели и всем ближайшим противникам.<br/>Может быть выполнено только под эффектом Starcross Ready.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 12
      "PVP Skill 12": {
         "name": 'Nastrond',
         ...
         "radius_img": 'R6',
         "radius": '15y',
         "content": 'Удар, наносящий урон по всем противникам по прямой линии перед персонажем с силой атаки 4,000.<br/>Сила атаки увеличивается до 8,000 по мере уменьшения HP цели и достигает максимального значения, когда у цели остается 50% HP или меньше.<br/>Эффект Life of the Dragon исчезает после использования.<br/>Может быть выполнено только под эффектом Nastrond Ready.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 13
      "PVP Skill 13": {
         "name": 'Wyrmwind Thrust',
