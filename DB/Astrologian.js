(() =>{
   let db = {
      ...
      "PVE Skill 04": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Снижает время применения заклинаний на 2.5 секунды.<br/>Продолжительность: 15 сек.<br/>Максимум зарядов: 2',
      },
      // PVE Skill 05
      "PVE Skill 05": {
         "name": 'Helios',
      ...
      "PVE Skill 34": {
         ...
         "radius_img": 'R2',
         "radius": '8y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 140 по цели и всем окружающим противникам.',
      },
      // PVE Skill 35
      "PVE Skill 35": {
         "name": 'Exaltation',
      ...
      "PVE Skill 38": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и всем окружающим противникам с силой атаки 860 по первому и на 50% по всем оставшимся.<br/>Может быть использовано только во время действия эффекта Divining.',
      },
      // PVE Skill 39 NEW
      "PVE Skill 39": {
      ...
      "PVP Skill 01": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 6,000.<br/>После использования с помощью Double Cast, уменьшает время повторного использования Double Cast на 6 секунд.',
      },
      // PVP Skill 02
      "PVP Skill 02": {
         "name": 'Aspected Benefic',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Восстанавливает HP цели.<br/>Сила лечения: 6,000<br/>Сила увеличивается до 9,000 по мере уменьшения HP цели, достигая максимального значения, когда у цели 50% HP или меньше.<br/>Дополнительный эффект: накладывает на цель эффект Diurnal Benefic<br/>Эффект Diurnal Benefic: постепенно восстанавливает HP<br/>Эффективность лечения: 3,000<br/>Продолжительность: 6 сек.<br/>Максимальные заряды: 2<br/>При использовании с помощью Double Cast, накладывает эффект Nocturnal Benefic.<br/>Эффект Nocturnal Benefic: создаёт магический барьер, который поглощает получаемый урон, равный равный силе лечения 4,000<br/>Продолжительность: 12 сек.<br/>Это умение не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 03
      "PVP Skill 03": {
         "name": 'Gravity II',
         ...
         "radius_img": 'R2',
         "radius": '8y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 7,500 по цели и всем окружающим противникам.<br/>Дополнительный эффект: накладывает на первую цель эффект тяжесть (heavy) +75%<br/>Продолжительность: 3 сек.<br/>После использования с помощью Double Cast накладывает эффект связывание (bind) на первую цель.<br/>Этот умение не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Double Cast',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Повторяет ранее использованный Fall Malefic, Aspected Benefic или Gravity II.<br/>Максимум зарядов: 2<br/>Может быть использовано только после Fall Malefic, Aspected Benefic или Gravity II.',
      },
      // PVP Skill 05
      "PVP Skill 05": {
         "name": 'Minor Arcana',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Вытягивает Lord of Crowns или Lady of Crowns из гадальной колоды.<br/>Умение меняется на вытянутый аркан.<br/>Продолжительность: 10 сек.',
      },
      // PVP Skill 06
      "PVP Skill 06": {
         "name": 'Macrocosmos',
         ...
         "radius_img": 'R2',
         "radius": '20y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 10,000 по цели и всем окружающим противникам.<br/>Дополнительный эффект: накладывает Macrocosmos на персонажа и всех ближайших сопартийцев<br/>Продолжительность: 10 сек.<br/>При выполнении действие меняется на Microcosmos.<br/>На время действия эффекта 25% получаемого урона накапливается.<br/>Восстанавливает HP, равное силе лечения 5,000, плюс суммарный урон по истечении срока действия эффекта или после выполнения Microcosmos.<br/>Этот умение не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'Epicycle',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Быстрый рывок вперед на 15 ялмов.<br/>Дополнительный эффект: оставляет позади себя Pole Star в точке начала рывка и накладывает на персонажа Retrograde Ready<br/>Продолжительность: 5 сек.<br/>Дополнительный эффект: создаёт магический барьер, который поглощает получаемый урон, равный равный силе лечения 6,000<br/>Продолжительность: 10 сек.<br/>Невозможно использовать, если персонаж находится под эффектами ограничивающими перемещение.<br/><br/>※Умением меняется на Retrograde после использования.',
      },
      // PVP Skill 08
      "PVP Skill 08": {
         "name": 'Lady of Crowns',
         ...
         "radius_img": 'R2',
         "radius": '20y',
         "content": 'Восстанавливает HP персонажа и HP всех ближайших сопартийцев.<br/>Сила лечения: 6,000<br/>Дополнительный эффект: уменьшает получаемый целью урон на 10%<br/>Продолжительность: 10 сек.<br/>Может быть использовано только под действием эффекта Lady of Crowns.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 09
      "PVP Skill 09": {
         "name": 'Lord of Crowns',
         ...
         "radius_img": 'R2',
         "radius": '20y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 6,000 по всем ближайшим противникам.<br/>Дополнительный эффект: увеличивает получаемый целью урон на 10%<br/>Продолжительность: 10 сек.<br/>Может быть использовано только под действием эффекта Lord of Crowns.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 10
      "PVP Skill 10": {
         "name": 'Retrograde',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Мгновенно перемещается на Pole Star, оставленную персонажем.<br/>Может быть использовано только под действием эффекта Retrograde Ready.<br/>Невозможно использовать, если персонаж находится под эффектами ограничивающими перемещение.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 11
      "PVP Skill 11": {
         "name": 'Microcosmos',
         ...
         "radius_img": 'R2',
         "radius": '20y',
         "content": 'Активирует исцеляющий эффект Macrocosmos, восстанавливающий HP, равное силе лечения 4,000 прибавляя 20% накопленного урона.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 12
      "PVP Skill 12": {
         "name": 'Oracle',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 6,000 по цели и всем окружающим противникам.<br/>Дополнительный эффект: оглушение (stun)<br/>Продолжительность: 2 сек.<br/>Может быть использовано только во время действия эффекта Divining.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill LB
      "PVP Skill LB": {
         ...
         "radius_img": 'R2',
         "radius": '15y',
         "content": 'Увеличивает наносимый урон и силу лечения персонажа и ближайших сопартийцев на 30% , а также снижает наносимый урон и силу лечения ближайших противников на 30%.<br/>Эффект снижается на 10% каждые 5 сек.<br/>Продолжительность: 15 сек.<br/>Дополнительный эффект: накладывает эффект Divining на персонажа<br/>Продолжительность: 15 сек.<br/>Может быть выполнено только тогда, когда шкала лимит брейка (limit gauge) заполнена.<br/>Время зарядки шкалы: 105 сек.<br/><br/>※ Умением меняется на Oracle после использования.',
      },
   };
   FILL_DB_VALUES(db);
   FILL_DB_SKILLS(db);
