(() =>{
   let db = {
      ...
      "PVP Skill 11": {
         ...
         "radius_img": 'R2',
         "radius": '20y',
         "content": 'Активирует исцеляющий эффект Macrocosmos, восстанавливающий HP, равное силе лечения 6,000 прибавляя 25% накопленного урона.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 12
      "PVP Skill 12": {
         "name": 'Oracle',
