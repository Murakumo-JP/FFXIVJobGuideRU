(() =>{
   let db = {
      ...
      "PVP Skill 03": {
         ...
         "radius_img": 'R2',
         "radius": '8y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 8,000 по цели и всем окружающим противникам.<br/>Дополнительный эффект: тяжесть (heavy) +75%<br/>Продолжительность: 3 сек.<br/>После использования с помощью Double Cast, увеличивает время эффекта тяжесть (heavy) до 5 секунд.<br/>Этот умение не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Double Cast',
      ...
      "PVP Skill 08": {
         ...
         "radius_img": 'R2',
         "radius": '20y',
         "content": 'Восстанавливает HP персонажа и HP всех ближайших сопартийцев.<br/>Сила лечения: 8,000<br/>Дополнительный эффект: уменьшает получаемый целью урон на 10%<br/>Продолжительность: 10 сек.<br/>Может быть использовано только под действием эффекта Lady of Crowns.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 09
      "PVP Skill 09": {
         "name": 'Lord of Crowns',
         ...
         "radius_img": 'R2',
         "radius": '20y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 8,000 по всем ближайшим противникам.<br/>Дополнительный эффект: увеличивает получаемый целью урон на 10%<br/>Продолжительность: 10 сек.<br/>Может быть использовано только под действием эффекта Lord of Crowns.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 10
      "PVP Skill 10": {
         "name": 'Retrograde',
