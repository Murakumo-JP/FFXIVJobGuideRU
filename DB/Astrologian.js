(() =>{
   let db = {
      ...
      "PVP Skill 02": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Восстанавливает HP цели.<br/>Сила лечения: 6,000<br/>Сила увеличивается до 9,000 по мере уменьшения HP цели, достигая максимального значения, когда у цели 50% HP или меньше.<br/>Дополнительный эффект: накладывает на цель эффект Diurnal Benefic<br/>Эффект Diurnal Benefic: постепенно восстанавливает HP<br/>Эффективность лечения: 4,000<br/>Продолжительность: 6 сек.<br/>Максимальные заряды: 2<br/>При использовании с помощью Double Cast, накладывает эффект Nocturnal Benefic.<br/>Эффект Nocturnal Benefic: создаёт магический барьер, который поглощает получаемый урон, равный равный силе лечения 4,000<br/>Продолжительность: 12 сек.<br/>Это умение не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 03
      "PVP Skill 03": {
         "name": 'Gravity II',
         ...
         "radius_img": 'R2',
         "radius": '8y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 8,000 по цели и всем окружающим противникам.<br/>Дополнительный эффект: тяжесть (heavy) +75%<br/>Продолжительность: 2 сек.<br/>После использования с помощью Double Cast, увеличивает время эффекта тяжесть (heavy) до 3 секунд.<br/>Этот умение не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Double Cast',
      ...
      "PVP Skill 05": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Вытягивает Lord of Crowns или Lady of Crowns из гадальной колоды.<br/>Умение меняется на вытянутый аркан.<br/>Продолжительность: 20 сек.',
      },
      // PVP Skill 06
      "PVP Skill 06": {
         "name": 'Macrocosmos',
