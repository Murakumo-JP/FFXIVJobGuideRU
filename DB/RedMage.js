(() =>{
   let db = {
      ...
      "PVP Skill 04": {
         ...
         "radius_img": 'R2',
         "radius": '30y',
         "content": 'Увеличивает урон, наносимый персонажем и ближайшими сопартийцами на 10%, а также снижает получаемый урон на 10%.<br/>Продолжительность: 8 сек.<br/>Дополнительный эффект: накладывает эффект Prefulgence Ready<br/>Продолжительность: 15 сек.<br/><br/>※Умение меняется на Prefulgence после использования.',
      },
      // PVP Skill 05
      "PVP Skill 05": {
         "name": 'Corps-a-corps',
      ...
      "PVP Skill 12": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и всем ближайшим противникам с силой атаки 12,000.<br/>Дополнительный эффект: восстанавливает HP персонажа<br/>Сила лечения: 12,000<br/>Дополнительный эффект: восстанавливает HP сопартийцев, находящихся рядом с целью<br/>Сила лечения: 12,000<br/>Можно использовать только под действием эффекта Prefulgence.',
      },
      // PVP Skill 13
      "PVP Skill 13": {
         "name": 'Vice of Thorns',
