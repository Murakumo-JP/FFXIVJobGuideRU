(() =>{
   let db = {
      ...
      "PVE Skill 03": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 220.<br/>Комбо умение: Spinning Edge<br/>Сила в комбо: 360<br/>Комбо бонус: восполняет шкалу Ninki Gauge на 5',
      },
      // PVE Skill 04
      "PVE Skill 04": {
         "name": 'Hide',
      ...
      "PVE Skill 28": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Рывок к цели и молниеносный удар, наносящий урон с силой атаки  640.<br/>Дополнительный эффект: увеличивает Ninki Gauge на 5<br/>Можно использовать только под действием эффекта Raiju Ready.<br/>Невозможно использовать, если персонаж находится под эффектами, ограничивающими перемещение.',
      },
      // PVE Skill 29
      "PVE Skill 29": {
         "name": 'Fleeting Raiju',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон молнией с силой атаки 640.<br/>Дополнительный эффект: увеличивает Ninki Gauge на 5<br/>Может быть использовано только под действием эффекта Raiju Ready.',
      },
      // PVE Skill 30 NEW
      "PVE Skill 30": {
         "name": "Kunai's Bane",
