(() =>{
   let db = {
      "PVE Update": `Последнее обновление: 24/03/2025`,
      "PVP Update": `Последнее обновление: 24/03/2025`,
      // PVE Skill 01
      "PVE Skill 01": {
         "name": 'Spinning Edge',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 280.<br/>Дополнительный эффект: восполняет шкалу Ninki Gauge на 5',
      },
      // PVE Skill 02
      "PVE Skill 02": {
         "name": 'Shade Shift',
      ...
      "PVE Skill 03": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 240.<br/>Комбо умение: Spinning Edge<br/>Сила в комбо: 400<br/>Комбо бонус: восполняет шкалу Ninki Gauge на 5',
      },
      // PVE Skill 04
      "PVE Skill 04": {
         "name": 'Hide',
      ...
      "PVE Skill 05": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Дальний удар, наносящий урон с силой атаки 200.<br/>Дополнительный эффект: восполняет шкалу Ninki Gauge на 5',
      },
      // PVE Skill 06
      "PVE Skill 06": {
         "name": 'Mug',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 150.<br/>Дополнительный эффект: увеличивает получаемый целью урон на 5%.<br/>Продолжительность: 20 сек.<br/>Дополнительный эффект: увеличивает шанс выпадения дополнительных предметов из цели (в открытом мире), если Mug нанесен до или в качестве завершающего удара',
      },
      // PVE Skill 07
      "PVE Skill 07": {
         "name": 'Trick Attack',
      ...
      "PVE Skill 08": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 220, при выполнении удара в спину цели 280.<br/>Комбо умение: Gust Slash<br/>Сила в комбо: 400<br/>Сила в комбо в спину цели: 460<br/>Сила атаки увеличивается на 100 под действием эффекта Kazematoi.<br/>Комбо бонус: восполняет шкалу Ninki Gauge на 15',
      },
      // PVE Skill 09
      "PVE Skill 09": {
         "name": 'Ten',
      ...
      "PVE Skill 17": {
         ...
         "radius_img": 'R1',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 100 по всем окружающим противникам.<br/>Комбо умение: Death Blossom<br/>Сила в комбо: 120<br/>Комбо бонус: восполняет шкалу Ninki Gauge на 5',
      },
      // PVE Skill 18
      "PVE Skill 18": {
         "name": 'Armor Crush',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 240, при выполнени удара сзади цели 300.<br/>Комбо умение: Gust Slash<br/>Сила в комбо: 440<br/>Сила в комбо со спины: 500<br/>Комбо бонус: дает 2 стака Kazematoi<br/>Kazematoi Effect: увеличивает силу атаки Aeolian Edge на 100<br/>Максимум стаков: 5<br/>Комбо бонус: восполняет шкалу Ninki Gauge на 15',
      },
      // PVE Skill 19
      "PVE Skill 19": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Тройной удар, каждый из которых наносит урон с силой атаки 180.',
      },
      // PVE Skill 20
      "PVE Skill 20": {
      ...
      "PVE Skill 21": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий критический урон в конусе перед персонажем с силой атаки 300.<br/>Дополнительный эффект: увеличивает получаемый целью урон на 5%.<br/>Продолжительность: 20 сек.<br/>Дополнительный эффект: увеличивает шанс выпадения дополнительных предметов из цели, если Dokumori наносится до или в качестве завершающего удара<br/>Дополнительный эффект: восполняет шкалу Ninki Gauge на 40<br/>Продолжительность: 30 сек.',
      },
      // PVE Skill 22
      "PVE Skill 22": {
         "name": 'Bhavacakra',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 400.<br/>Бонус Meisui: сила атаки увеличивается до 550, когда персонаж находится под эффектом Meisui<br/>Стоимость: 50 Ninki Gauge<br/>Имеет общее время восстановления с умением Hellfrog Medium.',
      },
      // PVE Skill 23
      "PVE Skill 23": {
         "name": 'Ten Chi Jin',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Временно превращает каждую из трех мудр в умение ниндзюцу.<br/>Выполнение одного из этих умений преобразует остальные мудры в различные действия ninjutsu, пока не будут выполнены все три или не истечет срок действия эффекта Ten Chi Jin.<br/>Продолжительность: 6 сек.<br/>Дополнительный эффект: накладывает эффект Tenri Jindo Ready<br/>Продолжительность: 30 сек.<br/>Можно использовать только ninjutsu, пока активно умение. Одно и то же ninjutsu не может быть выполнено дважды.<br/>Не может быть использовано под действием Kassatsu.',
      },
      // PVE Skill 24
      "PVE Skill 24": {
         "name": 'Meisui',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Рассеивает Shadow Walker, увеличивая шкалу Ninki Gauge на 50.<br/>Дополнительный эффект: накладывает эффект Meisui<br/>Эффект Meisui: увеличивает силу атаки Zesho Meppo до 850 и Bhavacakra до 550<br/>Продолжительность: 30 сек.<br/>Может быть выполнено только в бою и под действием эффекта Shadow Walker.',
      },
      // PVE Skill 25
      "PVE Skill 25": {
         "name": 'Bunshin',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Накладывает 5 стаков Bunshin, каждый из которых позволяет тени персонажа атаковать противников каждый раз, когда используется боевой навык. Сила атаки тени зависит от выполненной атаки, но не зависит от комбо бонусов.<br/>Сила атаки ближнего боя: 160<br/>Сила атаки дальнего боя: 160<br/>Сила атаки по площади: 80<br/>Ninki Gauge увеличивается на 5 каждый раз, когда тень персонажа наносит атаку.<br/>Продолжительность: 30 сек.<br/>Дополнительный эффект: накладывает Phantom Kamaitachi Ready.<br/>Продолжительность: 45 сек.<br/>Стоимость: 50 Ninki Gauge',
      },
      // PVE Skill 26
      "PVE Skill 26": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Тень персонажа атакует, нанося урон ветром по цели и всем ближайшим противникам в радиусе 5 ялмов с силой 600 для первого противника и на 25% меньше для всех остальных.<br/>Дополнительный эффект: увеличивает Ninki Gauge на 10<br/>Можно использовать только под действием эффекта Phantom Kamaitachi Ready.',
      },
      // PVE Skill 27
      "PVE Skill 27": {
         "name": 'Hollow Nozuchi',
      ...
      "PVE Skill 28": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Рывок к цели и молниеносный удар, наносящий урон с силой атаки  700.<br/>Дополнительный эффект: увеличивает Ninki Gauge на 5<br/>Можно использовать только под действием эффекта Raiju Ready.<br/>Невозможно использовать, если персонаж находится под эффектами, ограничивающими перемещение.',
      },
      // PVE Skill 29
      "PVE Skill 29": {
         "name": 'Fleeting Raiju',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон молнией с силой атаки 700.<br/>Дополнительный эффект: увеличивает Ninki Gauge на 5<br/>Может быть использовано только под действием эффекта Raiju Ready.',
      },
      // PVE Skill 30 NEW
      "PVE Skill 30": {
         "name": "Kunai's Bane",
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": "Удар, наносящий урон по цели и всем ближайшим противникам с силой 600 для первого противника и на 25% меньше для всех остальных.<br/>Дополнительный эффект: накладывает на цель эффект Kuna's Bane<br/>Эффект Kuna's Bane: увеличивает наносимый цели урон на 10%.<br/>Продолжительность: 15 сек.<br/>Может быть использовано только в скрытом (hidden) состоянии.",
      },
      // PVE Skill 31 NEW
      "PVE Skill 31": {
         ...
         "radius_img": 'R2',
         "radius": '6y',
         "content": 'Удар, наносящий урон огнем по цели и всем ближайшим противникам с силой атаки 260.<br/>Стоимость: 50 Ninki Gauge<br/>Может быть использовано только под действием эффекта Higi.<br/>Имеет общее время восстановления с умением Bhavacakra.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Hellfrog Medium меняется на Deathfrog Medium при соблюдении требований к выполнению.',
      },
      // PVE Skill 32 NEW
      "PVE Skill 32": {
         "name": 'Zesho Meppo',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 700.<br/>Бонус Meisui: сила атаки увеличивается до 850<br/>Стоимость: 50 Ninki Gauge<br/>Может быть использовано только под действием эффекта Higi.<br/>Имеет общее время восстановления с умением Hellfrog Medium.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Bhavacakra меняется на Zesho Meppo при соблюдении требований к выполнению',
      },
      // PVE Skill 33 NEW
      "PVE Skill 33": {
         "name": 'Tenri Jindo',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и всем ближайшим противникам с силой 1,100 для первого противника и на 25% меньше для всех остальных.<br/>Может быть использовано только под действием эффекта Tenri Jindo Ready.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Ten Chi Jin меняется на Tenri Jindo при соблюдении требований к выполнению',
      },
      // Ninjutsu 01
      "Ninjutsu 01": {
         "name": 'Fuma Shuriken',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Дальний удар ниндзюцу, наносящий урон с силой атаки 500.<br/>Комбинация мудр: одна любая Ten, Chi или Jin мудра<br/>При использовании активируется время восстановления боевых навыков, мудр и Ninjutsu.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Ninjtsu меняется на Fuma Shuriken при соблюдении требований к выполнению.',
      },
      // Ninjutsu 02
      "Ninjutsu 02": {
         "name": 'Katon',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон огнем с силой атаки 350 по цели и окружающим противникам.<br/>Комбинация мудр: Chi→Ten или Jin→Ten<br/>При использовании активируется время восстановления боевых навыков, мудр и Ninjutsu.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Ninjtsu меняется на Katon при соблюдении требований к выполнению.',
      },
      // Ninjutsu 03
      "Ninjutsu 03": {
         "name": 'Raiton',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон молнией с силой атаки 740.<br/>Дополнительный эффект: накладывает стак Raiju Ready<br/>Продолжительность: 30 сек.<br/>Максимум стаков: 3<br/>Эффект Raiju Ready заканчивается при выполнении любого боевого умения ближнего боя.<br/>Комбинация мудр: Ten→Chi или Jin→Chi<br/>При использовании активируется время восстановления боевых навыков, мудр и Ninjutsu.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Ninjtsu меняется на Raiton при соблюдении требований к выполнению.',
      },
      // Ninjutsu 04
      "Ninjutsu 04": {
         "name": 'Hyoton',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон льдом с силой атаки 350.<br/>Дополнительный эффект: связывание (bind)<br/>Продолжительность: 15 сек.<br/>Комбинация мудр: Ten→Jin или Chi→Jin<br/>При использовании активируется время восстановления боевых навыков, мудр и Ninjutsu.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Ninjtsu меняется на Hyoton при соблюдении требований к выполнению.',
      },
      // Ninjutsu 05
      "Ninjutsu 05": {
         "name": 'Huton',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон ветром с силой атаки 240 по цели и окружающим противникам.<br/>Дополнительный эффект: накладывает эффект Shadow Walker<br/>Эффект Shadow Walker: позволяет выполнить боевой навык, который требует нахождения под действием Hidden, не находясь под этим эффектом.<br/>Продолжительность: 20 сек.<br/>Комбинация мудр: Jin→Chi→Ten или Chi→Jin→Ten.<br/>При использовании активируется время восстановления боевых навыков, мудр и Ninjutsu.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Ninjtsu меняется на Huton при соблюдении требований к выполнению.',
      },
      // Ninjutsu 06
      "Ninjutsu 06": {
         "name": 'Doton',
      ...
      "Ninjutsu 07": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон водой с силой атаки 580.<br/>Дополнительный эффект: накладывает эффект Shadow Walker<br/>Продолжительность: 20 сек.<br/>Эффект Shadow Walker: позволяет выполнить боевой навык, который требует нахождения под действием Hidden, не находясь под этим эффектом.<br/>Комбинация мудр: Ten→Chi→Jin или Chi→Ten→Jin<br/>Выполнение активирует время восстановления боевых навыков, мудр и Ninjutsu.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Ninjtsu меняется на Suiton при соблюдении требований к выполнению.',
      },
      // Ninjutsu 08
      "Ninjutsu 08": {
         "name": 'Goka Mekkyaku',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящийУдар, наносящий урон огнем с силой атаки 600 по цели и всем окружающим противникам.<br/>Комбинация мудр: Chi→Ten или Jin→Ten<br/>Может выполняться только под эффектом Kassatsu.<br/>При использовании активируется время восстановления боевых навыков, мудр и Ninjutsu.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Ninjtsu меняется на Goka Mekkyaku при соблюдении требований к выполнению. урон огнем с силой атаки 600 по цели и всем окружающим противникам.<br/>Комбинация мудр: Chi→Ten или Jin→Ten<br/>Может использоваться только под действием эффекта Kassatsu.<br/>При использовании активируется время восстановления боевых навыков, мудр и Ninjutsu.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // Ninjutsu 09
      "Ninjutsu 09": {
         "name": 'Hyosho Ranryu',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон льдом с силой атаки 1,300.<br/>Комбинация мудр: Chi→Jin or Ten→Jin<br/>Может выполняться только под эффектом Kassatsu.<br/>При использовании активируется время восстановления боевых навыков, мудр и Ninjutsu.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Ninjtsu меняется на Hyosho Ranryu при соблюдении требований к выполнению.',
      },
      // Trait 01
      "Trait 01": {
         "name": 'All Fours',
      ...
      "Trait 03": {
         ...
         "job_icon": 'ROG',
         "level": '45',
         "content": 'Уменьшает время применения и время восстановления боевых навыков и заклинаний, а также задержку между авто атаками на 15%.',
      },
      // Trait 04
      "Trait 04": {
      ...
      "Trait 07": {
         ...
         "job_icon": 'NIN',
         "level": '66',
         "content": 'Улучшает умение Mug до Dokumori.',
      },
      // Trait 08
      "Trait 08": {
      ...
      "Trait 16": {
         ...
         "job_icon": 'NIN',
         "level": '92',
         "content": "Улучшает умение Trick Attack до Kunai's Bane.",
      },
      // Trait 17 NEW
      "Trait 17": {
         ...
         "job_icon": 'NIN',
         "level": '94',
         "content": 'Увеличивает силу атаки Spinning Edge до 300, Gust Slash до 240, Aeolian Edge до 220, Fuma Shuriken до 500, Raiton до 740, Suiton до 580, Armor Crush до 240, Bhavacakra до 400, Bhavacakra под действием эффекта Meisui до 550, Forked Raiju до 700 и Fleeting Raiju до 700.',
      },
      // Trait 18 NEW
      "Trait 18": {
         ...
         "job_icon": 'NIN',
         "level": '96',
         "content": 'Накладывает эффект Higi после использования Dokumori.<br/>Продолжительность: 30 сек.',
      },
      // Trait 19 NEW
      "Trait 19": {
         ...
         "job_icon": 'NIN',
         "level": '100',
         "content": 'Накладывает эффект Tenri Jindo Ready после использования Ten Chi Jin.<br/>Продолжительность: 30 сек.<br/>Ten Chi Jin меняется на Tenri Jindo под действием эффекта Tenri Jindo Ready.',
      },
      // PVP Skill 01
      "PVP Skill 01": {
         "name": 'Spinning Edge',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 5,000.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 02
      "PVP Skill 02": {
         "name": 'Gust Slash',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 6,000.<br/>Комбо умение: Spinning Edge<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 03
      "PVP Skill 03": {
         "name": 'Aeolian Edge',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 7,000.<br/>Комбо умение: Gust Slash<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Fuma Shuriken',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Дальний удар, наносящий урон с силой атаки 8,000.<br/>Максимум зарядов: 3<br/>Этот боевой навык не имеет общего времени восстановления с другими умениями.<br/><br/>※Умение меняется на Hyosho Ranryu под действием эффекта Three Mudra.',
      },
      // PVP Skill 05 NEW
      "PVP Skill 05": {
         "name": 'Dokumori',
         ...
         "radius_img": 'R4',
         "radius": '8y',
         "content": 'Удар, наносящий урон с силой атаки 2,000 по всем противникам в конусе перед персонажем.<br/>Дополнительный эффект: увеличивает получаемый целью урон на 10%<br/>Продолжительность: 8 сек.<br/>Дополнительный эффект накладывает эффект Zesho Meppo Ready<br/>Продолжительность: 10 сек.<br/><br/>※Умение меняется на Goka Mekkyaku под действием эффекта Three Mudra.<br/>※Aeolian Edge Combo меняется на Zesho Meppo под действием эффекта Zesho Meppo Ready.',
      },
      // PVP Skill 06
      "PVP Skill 06": {
         "name": 'Three Mudra',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Накладывает Three Mudra, позволяющие немедленно выполнить любое умение ninjutsu. Однако одно и то же умение ninjutsu не может быть выполнено последовательно.<br/>Продолжительность: 10 сек.<br/>Максимум зарядов: 2<br/><br/>※Умение меняется на Meisui под действием эффекта Three Mudra.<br/>※Все умения, кроме Seiton Tenchu, будут изменены на соответствующие умения ниндзюцу, под действием эффекта Three Mudra.',
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'Bunshin',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Дает 5 стаков Bunshin, каждый из которых позволяет тени персонажа атаковать противников каждый раз, когда используется боевой навык.<br/>Сила атаки Bunshin: 4,000<br/>Сила атаки уменьшается вдвое при использовании uma Shuriken, Zesho Meppo, Forked Raiju или Fleeting Raiju.<br/>Продолжительность: 20 сек.<br/>Дополнительный эффект: создает тень, поглощающую урон, равный силе лечения 8,000<br/>Продолжительность: 10 сек.<br/><br/>※Умение меняется на Huton под действием эффекта Three Mudra.',
      },
      // PVP Skill 08
      "PVP Skill 08": {
         "name": 'Shukuchi',
      ...
      "PVP Skill 09": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Наносит четыре удара, каждый из которых наносит урон с силой атаки 2,000.<br/>Может быть использовано только под действием Zesho Meppo Ready.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 10
      "PVP Skill 10": {
         "name": 'Assassinate',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 12,000.<br/>Игнорирует эффекты Guard при нанесении урона.<br/>Может быть использовано только под действием эффекта Hidden.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 11
      "PVP Skill 11": {
         "name": 'Forked Raiju',
      ...
      "PVP Skill 14": {
         ...
         "radius_img": 'R2',
         "radius": '6y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 4,000 по цели и всем окружающим противникам.<br/>Дополнительный эффект: периодический урон<br/>Сила атаки: 4,000<br/>Продолжительность: 12 сек.<br/>Можно использовать только под действием эффекта Three Mudra.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 15
      "PVP Skill 15": {
         "name": 'Meisui',
      ...
      "PVP Skill 16": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Накладывает эффект Huton, создавая барьер, поглощающий урон, равный силе лечения 16,000.<br/>Когда барьер активен, уменьшает время перезарядки боевых навыков на 20% и увеличивает скорость передвижения на 25%.<br/>Продолжительность: 10 сек.<br/>Скорость передвижения возвращается к нормальной, когда барьер поглотит весь урон.<br/>Можно использовать только под действием эффекта Three Mudra.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 17
      "PVP Skill 17": {
         "name": 'Doton',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Создает под ногами персонажа область оскверненной земли, наносящей урон с силой атаки 3,000 по всем противникам, вошедшим в него.<br/>Продолжительность: 10 сек.<br/>Дополнительный эффект: уменьшает получаемый урон на 15%, пока персонаж стоит на в области оскверненной земли<br/>Можно использовать только под действием эффекта Three Mudra.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 18
      "PVP Skill 18": {
         "name": 'Hollow Nozuchi',
      ...
      "PVP Skill LB": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Рывок к цели, наносящий удар с силой атаки 12,000, уничтожая противника, чье HP ниже 50%.<br/>При нанесении урона игнорирует эффекты Guard.<br/>Дополнительный эффект: накладывает на цель эффект Death Link<br/>Продолжительность: 2 сек.<br/>Убийство противника этим умением или под эффектом Death Link накладывает Unsealed Seiton Tenchu, позволяя повторно выполнить умение.<br/>Продолжительность: 8 сек.<br/>Длительность эффекта уменьшается на 1 сек. каждый раз, когда он применяется к цели с минимальной продолжительностью 4 сек.<br/>Не действует на неигровых персонажей или игроков, находящихся в роботах.<br/>Может быть выполнено только тогда, когда шкала лимит брейка (limit gauge) заполнена или под действием Unsealed Seiton Tenchu.<br/>Время зарядки шкалы: 90 сек.<br/>Невозможно использовать, если персонаж находится под эффектами ограничивающими перемещение.',
      },
   };
   FILL_DB_VALUES(db);
   FILL_DB_SKILLS(db);
