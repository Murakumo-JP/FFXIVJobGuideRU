(() =>{
   let db = {
      ...
      "PVE Skill 64": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон огнем по цели и всем ближайшим противникам с силой атаки 490 для первого и на 65% меньше для всех остальных.<br/>Может быть использовано только под действием эффекта Crimson Strike Ready.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Crimson Cyclone меняется на Crimson Strike при соблюдении требований к выполнению.',
      },
      // PVE Skill 65
      "PVE Skill 65": {
      ...
      "PVE Skill 70": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 460.<br/>Стоимость: 1 Aetherflow Gauge',
      },
      // PVE Skill 71 NEW
      "PVE Skill 71": {
         "name": 'Searing Flash',
      ...
      "PVE Skill 74": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон огнем с силой атаки 620.<br/>Может быть использовано только под действием эффекта Lightwyrm Trance.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Ruin III меняется на Umbral Impulse при соблюдении требований к выполнению.',
      },
      // PVE Skill 75 NEW
      "PVE Skill 75": {
         "name": 'Umbral Flare',
      ...
      "PVE Skill 79": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон по цели и всем ближайшим противникам с силой атаки 1,500 для первого и на 60% меньше для всех остальных.<br/>Можно использовать только во время призыва Solar Bahamut.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // Pet Action
      "Pet Action": {
         "name": 'Radiant Aegis',
      ...
      "PVP Skill 01": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 6,000.<br/><br/>※Умение меняется на  Ruin IV под действием эффекта Further Ruin.<br/>※Умение меняется на Astral Impulse под действием эффекта Dreadwyrm Trance.<br/>※Умение меняется на Fountain of Fire под действием эффекта Firebird Trance.',
      },
      // PVP Skill 02
      "PVP Skill 02": {
         "name": 'Mountain Buster',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 12,000 по всем ближайшим противникам в конусе перед персонажем.<br/>Дополнительный эффект: stun (оглушение)<br/>Продолжительность: 2 сек.<br/>Это умение не имеет общего времени восстановления с другими умениями.',
      },
      ...
      "PVP Skill 03": {
         ...
         "radius_img": 'R2',
         "radius": '10y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 8,000 по цели и всем ближайшим противникам.<br/>Дополнительный эффект: периодический урон<br/>Сила атаки: 4,000<br/>Продолжительность: 6 сек.<br/>Дополнительный эффект: увеличивает скорость передвижения персонажа и сопартийцев на 25%<br/>Продолжительность: 6 сек.<br/>Это умение не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Crimson Cyclone',
      ...
      "PVP Skill 05": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 4,000.<br/>Дополнительный эффект: накладывает эффект Further Ruin<br/>Продолжительность: 10 сек.<br/>Максимум зарядов: 2',
      },
      // PVP Skill 06
      "PVP Skill 06": {
         "name": 'Radiant Aegis',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Cоздает барьер вокруг персонажа или выбранного сопартийца, снижающий получаемый урон на 25% и поглощающий урон, равный силе лечения 10,000.<br/>Продолжительность: 10 сек.',
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'Ruin IV',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 8,000 по цели и ближайшим противникам.<br/>Может быть использовано только под действием эффекта Further Ruin.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 08
      "PVP Skill 08": {
         "name": 'Astral Impulse',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 8,000.<br/>Может быть использовано только под действием эффекта Dreadwyrm Trance.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 09
      "PVP Skill 09": {
         "name": 'Fountain of Fire',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 6,000.<br/>Может быть использовано только под действием эффекта Firebird Trance.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 10
      "PVP Skill 10": {
         "name": 'Crimson Strike',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 12,000 по первому противнику и 8,000 всех остальных противников.<br/>Дополнительный эффект: отталкивает противников на 5 ялмов от первой цели.<br/>Может быть использовано только под действием эффекта Crimson Strike Ready.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 11
      "PVP Skill 11": {
         "name": 'Deathflare',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 8,000 по цели и ближайшим противникам.<br/>Может быть использовано только под действием эффекта Dreadwyrm Trance.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 12
      "PVP Skill 12": {
         "name": 'Brand of Purgatory',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон огнем с силой атаки 4,000 по цели и ближайшим противникам.<br/>Дополнительный эффект: снижает наносимый целью урон на 50%<br/>Продолжительность: 6 сек.<br/>Может быть использовано только под действием эффекта Firebird Trance.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 13
      "PVP Skill 13": {
         "name": 'Wyrmwave',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий нестихийный урон с силой атаки 8,000.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 14
      "PVP Skill 14": {
         "name": 'Scarlet Flame',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон огнем с силой атаки 4,000.<br/>Дополнительный эффект: периодический урон<br/>Сила атаки: 4,000<br/>Продолжительность: 6 сек.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill LB1
      "PVP Skill LB1": {
         "name": 'Summon Bahamut',
