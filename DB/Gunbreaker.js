(() =>{
   let db = {
      ...
      "PVE Skill 05": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 100 по всем окружающим противникам.<br/>Дополнительный эффект: повышает уровень угрозы',
      },
      // PVE Skill 06
      "PVE Skill 06": {
         "name": 'Royal Guard',
      ...
      "PVE Skill 13": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 100 по всем окружающим противникам.<br/>Дополнительный эффект: повышает уровень угрозы<br/>Комбо умение: Demon Slice<br/>Сила в комбо: 160<br/>Комбо бонус: добавляет Cartridge на шкалу Powder Gauge',
      },
      // PVE Skill 14
      "PVE Skill 14": {
         "name": 'Aurora',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Накладывает на цель эффект периодического лечения (regen).<br/>Сила лечения: 300<br/>Продолжительность: 18 сек.<br/>Максимум зарядов: 2',
      },
      // PVE Skill 15
      "PVE Skill 15": {
         "name": 'Superbolide',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Уменьшает HP на 50% от максимального и делает персонажа невосприимчивым к большинству атак.<br/>Продолжительность: 10 сек.',
      },
      // PVE Skill 16
      "PVE Skill 16": {
         "name": 'Sonic Break',
      ...
      "PVE Skill 22": {
         ...
         "radius_img": 'R2',
         "radius": '30y',
         "content": 'Снижает получаемый физический на 5% и магический урон на 10% персонажу и сопартийцами в радиусе действия.<br/>Продолжительность: 15 сек.',
      },
      // PVE Skill 23
      "PVE Skill 23": {
         "name": 'Heart of Stone',
      ...
      "PVE Skill 32": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 200.<br/>Возможно использовать только под эффектом Ready to Blast.<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Continuation меняется на Hypervelocity при соблюдении требований к выполнению.',
      },
      // PVE Skill 33
      "PVE Skill 33": {
         "name": 'Double Down',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон по цели и по всем окружающим противникам с силой атаки 1,200 для первого и на 15% меньше для всех остальных.<br/>Стоимость: 1 Cartridge<br/>Этот боевой навык не имеет общего времени восстановления с другими умениями.',
      },
      // PVE Skill 34 NEW
      "PVE Skill 34": {
         "name": 'Great Nebula',
      ...
      "PVE Skill 36": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон по цели и по всем окружающим противникам с силой атаки 1,000 для первого и на 60% меньше для всех остальных.<br/>Возможно использовать только находясь под действием эффекта Ready to Raze.',
      },
      // PVE Skill 37 NEW
      "PVE Skill 37": {
         "name": 'Noble Blood',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон по цели и по всем окружающим противникам с силой атаки 1,100 для первого и на 60% меньше для всех остальных.<br/>Комбо умение: Reign of Beasts<br/><br/>※Это умение нельзя поместить на хотбар.<br/>※Reign of Beasts меняется на Noble Blood при соблюдении требований к выполнению.',
      },
      // PVE Skill 38 NEW
      "PVE Skill 38": {
         "name": 'Lion Heart',
      ...
      "Trait 12": {
         ...
         "job_icon": 'GNB',
         "level": '94',
         "content": 'Увеличитвает силу атаки умениям Keen Edge до 300, Brutal Shell до 240, Solid Barrel до 240, Burst Strike до 460, Gnashing Fang до 500, Savage Claw до 560, Wicked Talon до 620, Jugular Rip до 240, Abdomen Tear до 280, Eye Gouge до 320, Blasting Zone до 800 и Hypervelocity до 200.',
      },
      // Trait 13 NEW
      "Trait 13": {
      ...
      "PVP Skill 02": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 6,000.<br/>Комбо умение: Keen Edge<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 03
      "PVP Skill 03": {
         "name": 'Solid Barrel',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 7,000.<br/>Комбо умение: Brutal Shell<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 04
      "PVP Skill 04": {
         "name": 'Burst Strike',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 8,000.<br/>Комбо умение: Solid Barrel<br/>Дополнительный эффект: накладывает эффект Ready to Blast<br/>Продолжительность: 10 сек.<br/><br/>※Continuation меняется на Hypervelocity под действием эффекта Ready to Blast.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 05
      "PVP Skill 05": {
         "name": 'Gnashing Fang',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 7,000.<br/>Дополнительный эффект: накладывает эффект Ready to Rip<br/>Продолжительность: 10 сек.<br/><br/>※Continuation меняется на Jugular Rip под действием эффекта Ready to Rip.',
      },
      // PVP Skill 06
      "PVP Skill 06": {
         "name": 'Fated Circle',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 8,000 по всем окружающим противникам.<br/>Дополнительный эффект: накладывает эффект Nebula<br/>Продолжительность: 10 сек.<br/>Эффект Nebula: контратакует все входящие атаки<br/>Сила контратаки: 4,000<br/>Дополнительный эффект: накладывает эффект Ready to Raze<br/>Продолжительность: 10 сек.<br/>Этот боевой навык не имеет общего времени восстановления с другими умениями.',
      },
      // PVP Skill 07
      "PVP Skill 07": {
         "name": 'Continuation',
      ...
      "PVP Skill 09": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 5,000.<br/>Сила атаки увеличивается до 10, 000 по мере уменьшения HP цели и достигает максимального значения, когда у цели остается 50% HP или меньше.',
      },
      // PVP Skill 10
      "PVP Skill 10": {
         "name": 'Heart of Corundum',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Накладывает на персонажа или выбранного сопартийца эффекты Heart of Corundum и Catharsis of Corundum.<br/>Эффект Heart of Corundum: снижает получаемый урон на 10%<br/>Продолжительность: 10 сек.<br/>Эффект Catharsis of Corundum: восстанавливает HP, когда оно падает ниже 50% или по истечении срока действия эффекта<br/>Сила лечения: 12,000<br/>Продолжительность: 10 сек.',
      },
      // PVP Skill 11
      "PVP Skill 11": {
         "name": 'Savage Claw',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 8,000.<br/>Комбо умение: Gnashing Fang<br/>Дополнительный эффект: накладывает эффект Ready to Tear<br/>Продолжительность: 10 сек.<br/><br/>※Continuation меняется на Abdomen Tear под действием эффекта Ready to Tear.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 12
      "PVP Skill 12": {
         "name": 'Wicked Talon',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 9,000.<br/>Комбо умение: Savage Claw<br/>Дополнительный эффект: накладывает эффект Ready to Gouge<br/>Продолжительность: 10 сек.<br/><br/>※Continuation меняется на Eye Gouge под действием эффекта Ready to Gouge.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 13
      "PVP Skill 13": {
         "name": 'Hypervelocity',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 4,000.<br/>Дополнительный эффект: создает вокруг персонажа барьер, поглощающий урон равный силе лечения 8,000<br/>Продолжительность: 6 сек.<br/>Возможно использовать только находясь под эффектом Ready to Blast.<br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 14
      "PVP Skill 14": {
         "name": 'Fated Brand',
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Удар, наносящий урон с силой атаки 4,000 по всем ближайшим противникам.<br/>Дополнительный эффект: тяжесть (heavy) +75%<br/>Продолжительность: 4 сек.<br/>Дополнительный эффект: создает вокруг персонажа барьер, поглощающий урон равный силе лечения 8,000<br/>Продолжительность: 6 сек.<br/>Возможно использовать только находясь под эффектом Ready to Raze.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 15
      "PVP Skill 15": {
         "name": 'Jugular Rip',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 4,000.<br/>Дополнительный эффект: создает вокруг персонажа барьер, поглощающий урон равный силе лечения 6,000<br/>Продолжительность: 6 сек.<br/>Возможно использовать только находясь под эффектом Ready to Rip.<br/><br/>※Это умение нельзя поместить на хотбар.',
      },
      // PVP Skill 16
      "PVP Skill 16": {
         "name": 'Abdomen Tear',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 4,000.<br/>Дополнительный эффект: создает вокруг персонажа барьер, поглощающий урон равный силе лечения 6,000<br/>Продолжительность: 6 сек.<br/>Возможно использовать только находясь под эффектом Ready to Tear.<br/><br/>※Это умение нельзя поместить на хотбар',
      },
      // PVP Skill 17
      "PVP Skill 17": {
         "name": 'Eye Gouge',
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Удар, наносящий урон с силой атаки 4,000.<br/>Дополнительный эффект: создает вокруг персонажа барьер, поглощающий урон равный силе лечения 6,000<br/>Продолжительность: 6 сек.<br/>Возможно использовать только находясь под эффектом Ready to Gouge.<br/><br/>※Это умение нельзя поместить на хотбар',
      },
      // PVP Skill LB1
      "PVP Skill LB1": {
         ...
         "radius_img": 'R2',
         "radius": '5y',
         "content": 'Проводит серию ударов клинком, нанося периодический урон по всем окружающим противникам с силой атаки 4,000 и снижая получаемый урон на 25% до окончания действия эффекта.<br/>Продолжительность: 4 сек.<br/>Активирует Terminal Trigger после конца действия эффекта.<br/>Дополнительный эффект: накладывает на цель Relentless Shrapnel, увеличивает получаемый целью урон на 5%<br/>Продолжительность: 6 сек.<br/>Максимум стаков: 5<br/>Может быть выполнено во время движения.<br/>Может быть выполнено только тогда, когда шкала лимит брейка (limit gauge) заполнена.<br/>Время зарядки шкалы: 60 сек.<br/><br/>※При выполнении действие меняется на Terminal Trigger.',
      },
      // PVP Skill LB2
      "PVP Skill LB2": {
